...
var fnaSavieGame = {
	...
	page_recommendation: contextPath + "/" + language + "/savie-online/savie-product",
	debug : false,
	postData : {
		"gender" : null,
		"dob": null,
	...
	initGenericEvts:function(){
		...
		$(".game-fna").find("input[type=text]").keyup(function(){
			var formField = $(this).data("frmFld");
			var dataType = $(this).data("type");

			//check datatype (string,int)
			that.postData[formField] = ($(this).val() == "") ? null : (dataType == "int")? parseInt($(this).val(),10):  $(this).val();
