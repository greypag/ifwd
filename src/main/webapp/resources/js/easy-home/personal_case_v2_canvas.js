...
lib.properties = {
	...
	manifest: [
		...
		{src:window.eh_caseAniImgPath + "/case02_txt_v2.png", id:"case02_txt_v2"},
		...
		{src:window.eh_caseAniImgPath + "/case03_txt_v2.png", id:"case03_txt_v2"},
		...
		{src:window.eh_caseAniImgPath + "/case05_txt.png", id:"case05_txt"},
		...
		{src:window.eh_caseAniImgPath + "/main_txt_03.png", id:"main_txt_03"},
		{src:window.eh_caseAniImgPath + "/main_txt_04.png", id:"main_txt_04"},
...
p.nominalBounds = new cjs.Rectangle(0,0,564,41);
...
p.nominalBounds = new cjs.Rectangle(0,0,595,41);
...
p.nominalBounds = new cjs.Rectangle(0,0,631,41);
...
p.nominalBounds = new cjs.Rectangle(0,0,160,16);
...
p.nominalBounds = new cjs.Rectangle(0,0,214,17);
...
p.nominalBounds = new cjs.Rectangle(-10,0,123,17);
...
p.nominalBounds = new cjs.Rectangle(-10,13,214,17);
...
p.nominalBounds = new cjs.Rectangle(-10,15,160,16);
...
p.nominalBounds = new cjs.Rectangle(2.4,-1.7,564,41);
...
(lib.case_05_txt_main = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(61.5,0);
...
(lib.case_04_txt_main = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.case01_txt_v2();
	this.instance.setTransform(99.6,-4);
...
(lib.case_03_txt_main = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(84.3,9.8);
...
(lib.case_02_txt_main = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(76.6,0);
...
(lib.btnCaseE = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(77,61.5,1,1,0,0,0,39,9);
...
(lib.btnCaseD = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(130,119.6,0.884,0.006,0,180,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(30));

	// Layer 2
	this.instance = new lib.main_txt_04_1();
	this.instance.setTransform(77,50.5,1,1,0,0,0,39,9);
...
p.nominalBounds = new cjs.Rectangle(0,0,260,119.9);
...
(lib.btnCaseC = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(67,61.5,1,1,0,0,0,39,9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({x:77},0).wait(29));
...
(lib.personal_case_v2_canvas_en = function(mode,startPosition,loop) {
	...
	this.btnCaseE.setTransform(894,408.2,1,1,0,0,0,130,48.1);

	this.btnCaseD = new lib.btnCaseD();
	this.btnCaseD.setTransform(894,287.9,1,1,0,0,0,130,48.1);

	this.btnCaseC = new lib.btnCaseC();
	this.btnCaseC.setTransform(894,168.1,1,1,0,0,0,130,48.1);

	this.btnCaseB = new lib.btnCaseB();
	this.btnCaseB.setTransform(894,48.1,1,1,0,0,0,130,48.1);

	this.btnCaseA = new lib.btnCaseA();
	this.btnCaseA.setTransform(894,-64.9,1,1,0,0,0,130,48.1);
...
p.nominalBounds = new cjs.Rectangle(1276,127,260,593);
