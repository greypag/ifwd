...
function tPlanValid()
{
	...
	if (appHkid.trim() == "") {
		if (selectHkidPass == "hkId") {
			document.getElementById("errAppHkid").innerHTML = "Please Fill Out Your HKID Number";
			flag = false;
		}
		else {
			document.getElementById("errAppHkid").innerHTML = "Please Fill Out Your Passport Number";
			flag = false;
		}
	}
	else {
		if (selectHkidPass == "hkId") {
			var tr = IsHKID(appHkid.trim());
			if (tr == false) {
				document.getElementById("errAppHkid").innerHTML = "Please Enter Valid HKID Number";
				flag = false;
			}
		}
		else {
			...
			if (tr == false) {
				document.getElementById("errAppHkid").innerHTML = "Please Enter Valid Passport Number";
				flag = false;
			}
		}
	}
	...
	for (var i = 1; i <= parseInt(rowCountAdult) ; i++)
	{
		...
		if (hkid.trim() == "") {
			if (selectAdHkidPass == "hkId") {
				document.getElementById("errtxtInsuHkid"+i).innerHTML = "Please Fill Out Your HKID Number";
				flag = false;
			}
			else {
				document.getElementById("errtxtInsuHkid"+i).innerHTML = "Please Fill Out Your Passport Number";
				flag = false;
			}
		}
		else {
			if (selectAdHkidPass == "hkId") {
				var tr = IsHKID(hkid.trim());
				if (tr == false) {
					document.getElementById("errtxtInvalidInsuHkid"+i).innerHTML = "Please Enter Valid HKID Number";
					flag = false;
				}
			}
			else {
				...
				if (tr == false) {
					document.getElementById("errtxtInvalidInsuHkid"+i).innerHTML = "Please Enter Valid Passport Number";
					flag = false;
				}
			}
		}
		...
		if(selectedValue != "SE"){
			...
			if (hkid.trim() == "") {
				if (selectOtHkidPass == "hkId") {
					document.getElementById("erradultBenefitiaryHKId"+i).innerHTML = "Please Fill Out Your HKID Number";
					flag = false;
				}
				else {
					document.getElementById("erradultBenefitiaryHKId"+i).innerHTML = "Please Fill Out Your Passport Number";
					flag = false;
				}
			}
			else {
				if (selectOtHkidPass == "hkId") {
					var tr = IsHKID(hkid.trim());
					if (tr == false) {
						document.getElementById("errInvalidadultBenefitiaryHKId"+i).innerHTML = "Please Enter Valid HKID Number";
						flag = false;
					}
				}
				else {
					var tr = chkTravelHKPass(hkid.trim());
					if (tr == false) {
						document.getElementById("errInvalidadultBenefitiaryHKId"+i).innerHTML = "Please Enter Valid Passport Number";
						flag = false;
					}
				}
			}
	...
	for (var i = 1; i <= parseInt(rowCountChild) ; i++)
	{
		...
		if (hkid.trim() == "") {
			if (selectChldHkidPass == "hkId") {
				document.getElementById("errtxtChldInsuHkid"+i).innerHTML = "Please Fill Out Your HKID Number";
				flag = false;
			}
			else {
				document.getElementById("errtxtChldInsuHkid"+i).innerHTML = "Please Fill Out Your Passport Number";
				flag = false;
			}
		}
		else {
			if (selectChldHkidPass == "hkId") {
				var tr = IsHKID(hkid.trim());
				if (tr == false) {
					document.getElementById("errtxtChldInvalidInsuHkid"+i).innerHTML = "Please Enter Valid HKID Number";
					flag = false;
				}
			}
			else {
				var tr = chkTravelHKPass(hkid.trim());
				if (tr == false) {
					document.getElementById("errtxtChldInvalidInsuHkid"+i).innerHTML = "Please Enter Valid Passport Number";
					flag = false;
				}
			}
		}
		...
		if(selectedValue != "SE"){
			...
			if (hkid.trim() == "") {
				if (selectOtHkidPass == "hkId") {
					document.getElementById("errtxtchildInsuHkid"+i).innerHTML = "Please Fill Out Your HKID Number";
					flag = false;
				}
				else {
					document.getElementById("errtxtchildInsuHkid"+i).innerHTML = "Please Fill Out Your Passport Number";
					flag = false;
				}
			}
			else {
				if (selectOtHkidPass == "hkId") {
					var tr = IsHKID(hkid.trim());
					if (tr == false) {
						document.getElementById("errtxtInvalidchildInsuHkid"+i).innerHTML = "Please Enter Valid HKID Number";
						flag = false;
					}
				}
				else {
					var tr = chkTravelHKPass(hkid.trim());
					if (tr == false) {
						document.getElementById("errtxtInvalidchildInsuHkid"+i).innerHTML = "Please Enter Valid Passport Number";
						flag = false;
					}
				}
			}
	...
	for (var i = 1; i <= parseInt(rowCountOther) ; i++)
	{
		...
		if (hkid.trim() == "") {
			if (selectOtHkidPass == "hkId") {
				document.getElementById("errtxtOtherInsuHkid"+i).innerHTML = "Please Fill Out Your HKID Number";
				flag = false;
			}
			else {
				document.getElementById("errtxtOtherInsuHkid"+i).innerHTML = "Please Fill Out Your Passport Number";
				flag = false;
			}
		}
		else {
			if (selectOtHkidPass == "hkId") {
				var tr = IsHKID(hkid.trim());
				if (tr == false) {
					document.getElementById("errtxtOtherInvalidInsuHkid"+i).innerHTML = "Please Enter Valid HKID Number";
					flag = false;
				}
			}
			else {
				var tr = chkTravelHKPass(hkid.trim());
				if (tr == false) {
					document.getElementById("errtxtOtherInvalidInsuHkid"+i).innerHTML = "Please Enter Valid Passport Number";
					flag = false;
				}
			}
		}
		...
		if(selectedValue != "SE"){
			...
			if (hkid.trim() == "") {
				if (selectOtHkidPass == "hkId") {
					document.getElementById("errtxtOtherBenInsuHkid"+i).innerHTML = "Please Fill Out Your HKID Number";
					flag = false;
				}
				else {
					document.getElementById("errtxtOtherBenInsuHkid"+i).innerHTML = "Please Fill Out Your Passport Number";
					flag = false;
				}
			}
			else {
				if (selectOtHkidPass == "hkId") {
					var tr = IsHKID(hkid.trim());
					if (tr == false) {
						document.getElementById("errtxtOtherInvalidBenInsuHkid"+i).innerHTML = "Please Enter Valid HKID Number";
						flag = false;
					}
				}
				else {
					var tr = chkTravelHKPass(hkid.trim());
					if (tr == false) {
						document.getElementById("errtxtOtherInvalidBenInsuHkid"+i).innerHTML = "Please Enter Valid Passport Number";
						flag = false;
					}
				}
			}
...
function validateJoinUsForm() {
	...
	document.getElementById("errorJoinUsPassword").style.display = "none";
