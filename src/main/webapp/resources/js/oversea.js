...
// <key id='Overseas.userdetails.Instituation.Error.Empty'>Please enter your address.</key>
...
// <key id='Overseas.userdetails.applicant.Correspondence.Error.BorE'>Either Building or Estate must be filled in.</key>
...
function tPlanValid()
{
	...
	var correspondenceAddressDistrictId1 = document.getElementById("correspondenceAddressDistrictId1").checked;
	var correspondenceAddressDistrictId2 = document.getElementById("correspondenceAddressDistrictId2").checked;
	var correspondenceAddressDistrictId3 = document.getElementById("correspondenceAddressDistrictId3").checked;
	...
	if (insuredDob.trim() == '')
	{
		$("#input_dob2").addClass("invalid-field");
		$("#dobInsuredInvalid").html( getBundle(getBundleLanguage, "Please enter Date of Birth"));
		flag = false;		
	}
	else
	{
		$("#input_dob2").removeClass("invalid-field");
		$("#dobInsuredInvalid").html('');		
	}
	if (inputOverseasInsuredDob.trim() == '')
	{
		$("#input_dob3").addClass("invalid-field");
		$("#dobOverseasInsuredInvalid").html( getBundle(getBundleLanguage, "Please enter Date of Birth"));
		flag = false;		
	}
	else
	{
...
//Overseas.userdetails.Instituation.Country.NotCoveredAsia.url
	...
	if(plan == "Asia" && asis_country_list.indexOf(countryOfInstitution) < 0)
	{
...
//<key id='Overseas.userdetails.applicant.Correspondence.Error.District'>Please select a district.</key>
	if(!correspondenceAddressDistrictId1 && !correspondenceAddressDistrictId2 && !correspondenceAddressDistrictId3)
	{
		$("#"+'correspondenceAddressDistrictId1').addClass("invalid-field");
		$("#"+'correspondenceAddressDistrictId2').addClass("invalid-field");
		$("#"+'correspondenceAddressDistrictId3').addClass("invalid-field");
		$("#errorEmptycorrespondenceAddressDistrict").html( getBundle(getBundleLanguage, 'Please select a district.')); 
		flag = false;
	}
	else
	{
		$("#"+'correspondenceAddressDistrictId1').removeClass("invalid-field");
		$("#"+'correspondenceAddressDistrictId2').removeClass("invalid-field");
		$("#"+'correspondenceAddressDistrictId3').removeClass("invalid-field");
