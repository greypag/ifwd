<script>
	$(function(){
		...
		ogTitle = (ogTitle=='')?defaultOg[UILANGUAGE.toUpperCase()]['title']:ogTitle;
		ogDesc = (ogDesc=='')?defaultOg[UILANGUAGE.toUpperCase()]['desc']:ogDesc;
		ogUrl = (ogUrl=='')?defaultOg[UILANGUAGE.toUpperCase()]['url']:ogUrl;
		ogImg = (ogImg=='')?defaultOg[UILANGUAGE.toUpperCase()]['img']:ogImg;
