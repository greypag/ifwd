	...
	<nav class="navbar navbar-inverse">
		<div class="container pad-none">
			...
			<div class="col-lg-6 col-md-6 pull-right">
				...
				<ul class="maintabs">
	  <li class="col-lg-4 col-md-4 pad-none main-tab <% if(actionName.equals("Working")){ %> active <%} %>"><a href="<%=request.getContextPath()%>/workingholiday-insurance" class="travel-and-home-tab"><fmt:message key="header.product.travel" bundle="${msg}" /></a> </li>
