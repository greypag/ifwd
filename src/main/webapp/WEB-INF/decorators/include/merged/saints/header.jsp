			...
			<div class="fwd-container-limit clearfix">
				<div class="pull-left logo-position"> 
					<a href="/fwd-savie" title="FWD">
						<img src="<%=request.getContextPath()%>/resources/images/logo.jpg" class="img-responsive" title="FWD">
					</a>
				</div>
			...
			<div class="right-mobile-menu">
				...
				<div id="mobileMenu" class="mobile-accrdn-list">
					<div class="list-group">
						...
						<%}else{%>
								<a href="#login-button-mobile" class="list-group-item login-to-fwd padding-all" data-toggle="collapse" data-parent="#mobileMenu"><img src="<%=request.getContextPath()%>/resources/images/mobile-lock.png" class="lock">Log in to account</a>
						<%}%>
