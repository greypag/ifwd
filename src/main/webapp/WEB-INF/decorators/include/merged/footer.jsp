    ...
    <div class="row">
      <div class="col-sm-6 pad-none">
        <ul class="pull-left foot-links">
          ...
          <li  class="divider"><a href="<%=request.getContextPath()%>/<fmt:message key="footer.menu.faq.link" bundle="${msg}" />" target="_blank"><fmt:message key="footer.menu.faq" bundle="${msg}" /></a></li>
...
<div id="mob-footer" class="hidden-lg hidden-md mob-bottom">
    <div>
        ...
        <a href="<%=request.getContextPath()%>/<fmt:message key="footer.menu.faq.link" bundle="${msg}" />" target="_blank"><fmt:message key="footer.menu.faq" bundle="${msg}" /></a> |
