                                    ...
                                    <div>
		                               ...
		                               <div class="form-group float" id="personalbenificiaryId${inx}">
		                                   ...
		                                   <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
                                               ...
                                               <!-- **Gary**
                                               onblur="
                                               placeholderOnBlur(this,'<fmt:message key="flight.details.insured.beneficiary.name.placeholder" bundle="${msg}" />');
                                               validateName('personalBenefitiaryId${inx}','errpersonalBenefitiaryId${inx}',false,'beneficiary');
                                               "
                                                -->
