      ...
      <div class="col-xs-12 col-sm-4 col-md-4 pad-none ">
        <div class="recent-work-wrap wrap  text-center">
          <div class="recent-work-inner"> <img src="resources/images/time.png" alt=""  />
            ...
            <p>
              <fmt:message key="light.main.highlight1.desc.part1" bundle="${msg}" /><a href=" http://www.fwd.com.hk/en-US/fwd-n-you/e_services_app.html" target="_blank"><fmt:message key="light.main.highlight1.desc.part2" bundle="${msg}" /> </a>  <fmt:message key="light.main.highlight1.desc.part3" bundle="${msg}" />
            </p>
            </div>
        </div>
      </div>
        ...
        <div class="col-lg-4 col-md-4 pad-none">
          <div class="services-wrap service-bx2">
            <div>
              ...
              <h3>
                <a href="http://blog.fwd.com.hk/en_US/2015/03/17/staying-connected-while-travelling-abroad/" target="_blank"> <fmt:message key="flight.main.blog.subheading2" bundle="${msg}" /><i class="fa fa-caret-right"></i>
                </a>
              </h3>
            </div>
          </div>
