...
<li><a href="#">##flight.breadcrumb1.item3@@ </a> <i class="fa fa-caret-right"></i></li>
<li><a href="#">##flight.breadcrumb1.item4@@ </a></li>
<li class="active "><i class="fa fa-caret-right"></i> ##flight.breadcrumb1.item5@@</li>
</ol>
<div class="container ">
<div
...
<h2>##flight.confirmation.jumbo@@</h2>
</div>
<br> <br>
...
<span class="status status-working">##flight.breadcrumb2.item2@@</span>
</div>
...
<h3>
##flight.confirmation.msg.part1@@ <strong>##flight.confirmation.msg.part2@@</strong>
##flight.confirmation.msg.part3@@ <strong>##flight.confirmation.msg.part4@@</strong>##flight.confirmation.msg.part5@@<strong> <%-- <%=request.getAttribute("email")%> --%>
<%=request.getSession().getAttribute(
"setEmailForConfirmation")%>
</strong> ##flight.confirmation.msg.part6@@
</h3>
...
<h4 class="center-h2">##flight.confirmation.heading@@</h4>
<h3 class="center-h3">##flight.confirmation.subheading@@</h3>
<br>
</div>
<!--Start Travel Plan  -->
...
<h2>
									...
									{%> ##flight.confirmation.upgrade.plan1.type@@<br> HK$ 1,000,000 ##flight.confirmation.upgrade.plan1.medical@@ 
								<%}	else{ %>
								##flight.confirmation.upgrade.plan2.type@@<br> HK$	500,000 ##flight.confirmation.upgrade.plan2.medical@@
									<%} %>
...
class="fwdpanel-minimize uline">##flight.confirmation.upgrade.plan1.benefits@@ </a> </span>
</h4>
</div>
...
<div class="fwdpanel-body" style="display: none;">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<p>
			<i class="fa fa-plus"></i> ##flight.confirmation.upgrade.plan1.benefits.desc1@@ <br> 
			<i class="fa fa-plus"></i> ##flight.confirmation.upgrade.plan1.benefits.desc2@@<br> 
			<i class="fa fa-plus"></i> ##flight.confirmation.upgrade.plan1.benefits.desc3@@<br>
			<i class="fa fa-plus"></i> ##flight.confirmation.upgrade.plan1.benefits.desc4@@<br>
		</p>
	</div>
</div>
<div class="clearfix"></div>
</div>
<h5> <a href="javascript:void(0)" onclick="setPriceAndColor('box<%=i%>','<%=travelQuote.getPlanName()[i]%>','<%=travelQuote.getToalDue()[i]%>')">##flight.confirmation.upgrade.action@@</a> </h5>
</div>
</div>
