...
action="flight-confirmation" onsubmit="return fPlanValid();"> --%>
			<form:form name="freeFlightForm" id="freeFlightForm"
				...
				<ol class="breadcrumb pad-none">
					<li><a href="#">##flight.breadcrumb1.item1@@</a> <i class="fa fa-caret-right"></i></li>
					<li><a href="#">##flight.breadcrumb1.item2@@ </a> <i class="fa fa-caret-right"></i></li>
					<li><a href="#">##flight.breadcrumb1.item3@@ </a></li>
					<li class="active "><i class="fa fa-caret-right"></i> ##flight.breadcrumb1.item4@@</li>
				</ol>
					...
					<div
						...
						<div class="order-status">
							...
							<div
								...
								<span class="status status-working">##flight.breadcrumb2.item1@@</span>
							</div>
							<div
								class="image-order-status image-order-status-active active img-circle">
								<div class="icon">2</div>
								<span class="status">##flight.breadcrumb2.item2@@</span>
							</div>
							<div
								class="image-order-status image-order-status-intransit disabled  img-circle">
								<div class="icon">3</div>
								<span class="status min-left">##flight.breadcrumb2.item3@@</span>
							</div>
						</div>
					</div>
				</div>
...
<div --%>
				<div class="container pad-none bdr ur-opt-content gray-bg3">
					...
					<div
						...
						%>
						<h3
							class="margin-left-2 h2-3-existing-fwd-head hidden-sm hidden-xs">##flight.details.login@@</h3>
						<h3
							class="margin-left-2 h2-3-existing-fwd-head hidden-lg hidden-md">##flight.details.login@@</h3>

						<a href="#"
							class="col-lg-5 col-md-5 col-sm-5 col-xs-5 btn-box-2 margin-left-2 color4"
							data-toggle="modal" data-target=".bs-example-modal-lg">##flight.details.login.action@@</a>


						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-left">
							<h3 class="text-left or-continue">
								<span>##flight.details.login.other.part1@@</span> ##flight.details.login.other.part2@@
							</h3>
						</div>
						<%
							}
							...
							<tbody>
								<tr>
									<td colspan="2" class="pad-none"><h3
											class="black-bold pad-none">##flight.details.applicant.heading@@</h3></td>
								</tr>
								<tr>


									<td valign="middle" class="col-sm-4 pad-none"><label
										for="inputFullName" class="control-label bold-500">##flight.details.applicant.name@@</label></td>
								...
								<tr>
									<td valign="middle" class="pad-none"><label
										for="inputEmail3" class="control-label bold-500">##flight.details.applicant.hkid@@</label></td>
								...
								<tr>
									<td valign="middle" class="pad-none"><label
										for="inputMobileNo" class="control-label bold-500">##flight.details.applicant.mobile@@</label></td>
									<td class="pad-none"><input type="text"
								...
								<tr>
									<td valign="middle" class="pad-none"><label
										for="inputEmailId" class="control-label bold-500">##flight.details.applicant.email@@</label></td>
						...
						<div class="gray-bg3-wid">
							<table class="table plandetail-form margin-left-2 vert-middle"
								...
								<tbody>
									<tr>
										<td colspan="2" class="pad-none"><h3 class="pad-none">##flight.details.registration.heading @@</h3> 
											<i>##flight.details.registration.desc@@</i> <br></td>
									</tr>
									<tr>
									...
									<tr>
										<td class="col-sm-4 pad-none"><label for="inputEmail3"
											class="control-label bold-500">##flight.details.registration.username@@</label></td>
									...
									<tr>
										<td class="pad-none"><label for="inputEmail3"
											class="control-label bold-500">##flight.details.registration.password@@</label></td>
									...
									<tr>
										<td class="pad-none"><label for="inputEmail3"
											class="control-label bold-500">##flight.details.registration.confirmPassword@@</label></td>
										<td class="pad-none"><input type="password"
						...
						<h3 class="black-bold pad-none margin-left-2">
							##flight.details.insured.heading@@<br>
						</h3>
...
##flight.details.insured.label.family.parent@@ 
</c:when>
													<c:when test="${totalAdultCount != 2}">
...
##flight.details.insured.label.family.parent@@ 
									...
									<div class="row ">
										<div class="col-xs-12 col-sm-6 col-md-6">
											<label class="bold-500">##flight.details.insured.name@@</label> <input type="text"
										...
										<div class="col-xs-12 col-sm-6 col-md-6">
											<label class="pad-left1 bold-500">##flight.details.insured.hkid@@</label> <input
									...
									<div class="row top-mrg-10">
										<div class="col-xs-12 col-sm-6 col-md-6">
											<label class="bold-500">##flight.details.insured.age@@</label>
											<t:dropdown 
										...
										<div class="col-xs-12 col-sm-6 col-md-6">
											<label class="pad-left1 bold-500">##flight.details.insured.beneficiary@@</label> 
											<t:dropdown 
										...
										<div id="adultsbenificiaryId${inx}" class="hide">
											<div class="col-xs-12 col-sm-6 col-md-6">
												<label class="bold-500">##flight.details.insured.beneficiary.name@@</label> <input type="text"
											...
											<div class="col-xs-12 col-sm-6 col-md-6">
												<label class="pad-left1 bold-500">##flight.details.insured.beneficiary.hkid@@</label> <input
							...
							<c:forEach var="inx" begin="1" end="${totalChildTraveller}">
								<div id="childtraveller">
									<h4 class="color1">
										##flight.details.insured.label.family.child@@
									...
									<div class="row top-mrg-10">
										<div class="col-xs-12 col-sm-6 col-md-6">
											<label class="bold-500">A##flight.details.insured.age@@</label> 
											<t:dropdown 
												defaultLabel="Select One"
												onChange=""
							...
							<c:forEach var="inx" begin="1" end="${totalOtherTraveller}">
								<div id="childtraveller">
									<h4 class="color1">
										##flight.details.insured.label.family.others@@
										<c:out value="${inx}"></c:out>
									</h4>
									<div class="row ">
										<div class="col-xs-12 col-sm-6 col-md-6">
									...
									<div class="row top-mrg-10">
										...
										<div id="otherbenificiaryId${inx}" class="hide">
											<div class="col-xs-12 col-sm-6 col-md-6">
												<label class="bold-500">F##flight.details.insured.beneficiary.name@@</label> <input type="text"
						...
						<h4 class="h4-2 padding3">##flight.details.declarations.heading@@</h4>
						<div class="declaration-content">
							<div class="checkbox">
								<input id="checkbox1" name="checkbox1" type="checkbox">
								<label for="checkbox1"> ##flight.details.declarations.tnc@@ <br> 
									i. <span class="margin-left-2"></span>##flight.details.declarations.tnc.desc1@@<br> 
									ii. <span class="margin-left-2"></span>##flight.details.declarations.tnc.desc2@@<br>
									iii. <span class="margin-left-2"></span>##flight.details.declarations.tnc.desc3@@<br /> 
									iv. <span class="margin-left-2"></span>##flight.details.declarations.tnc.desc4@@<br /> 
									v. <span class="margin-left-2"></span>##flight.details.declarations.tnc.desc5@@<br/>
								</label>
							</div>
							...
							<div class="checkbox">
								<input id="checkbox2" type="checkbox"> <label for="checkbox2">
									##flight.details.declarations.PICS.part1@@ <a
									href="https://home.fwd.com.hk/giphw/FWD_Resources/GI_Personal%20Data%20Protection%20Policy%20and%20Practices.pdf"
									target="_blank" class="sub-link"> ##flight.details.declarations.PICS.part2@@</a> ##flight.details.declarations.PICS.part3@@ <br>
							...
							<div>
								##flight.details.declarations.PDPO@@
							</div>
							<div class="checkbox">
								<input id="checkbox3" type="checkbox"> <label
									for="checkbox3"> ##flight.details.declarations.PDPO.option1@@ <br>
								</label>
							</div>

							<div class="checkbox">
								<input id="checkbox4" type="checkbox"> <label
									for="checkbox4"> ##flight.details.declarations.PDPO.option2@@ <br> <br>
								</label>
							</div>
					...
					<div
						...
						<div class="hidden-sm hidden-xs">
							<div class="wd2">
								<div class="pull-left">
									<h2 class="h2-3-choose">##flight.details.summary.product@@</h2>
									<h4>
										<!-- Plan Summary -->
									</h4>
								</div>
							...
							<div class="form-container">
								...
								<h3 class="txt-bold">
									##flight.details.summary.option1@@ <span class="span2 uline">
									<a href="flight">##flight.details.summary.change@@</a></span>
								</h3>
								...
								<h3 class="txt-bold">
									##flight.details.summary.option2@@ <span class="span2 uline">
									<a href="flight">##flight.details.summary.change@@</a></span>
								</h3>
								<h4>${planDetailsForm.getReturnDate()}</h4>
								<h3 class="txt-bold">
									##flight.details.summary.option3@@ <span class="span2 uline">
									<a href="flight">##flight.details.summary.change@@</a></span>
								</h3>
								<h4>
								...
								<h3 class="txt-bold">
									##flight.details.summary.option4@@<span>${planDetailsForm.getDays()}</span>
								</h3>
								<br>
							</div>
							<div class="orange-bdr"></div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pull-left">
							<a href="flight" class="bdr-curve btn btn-primary bck-btn">##flight.details.action.back@@
							</a>
						</div>
...
onclick="return flightPlanValidation();">Next</button> -->
				...
				<p class="padding1 hidden-sm hidden-xs">
					##flight.details.other.disclaimer.part1@@ <a
						class="sub-link"
						href="resources/policy-provisions-pdf/FlightCare_Provisions_Mar_2015.pdf" target="_blank">##flight.details.other.disclaimer.part2@@</a> ##flight.details.other.disclaimer.part3@@<br> ##flight.details.other.disclaimer.part4@@
				</p>
			</form:form>
		</div>
		<!--/.row-->
			...
			<form name="popUploginform" id="popUploginform" class="">
				<div class="login-form">
					...
					<div class="form-container">
						...
						<h4>
							##header.login.username@@ <a href="forgotUserName" class="pull-right sub-link">##header.login.username.forget@@</a>
						</h4>
						...
						<h4>
							##header.login.password@@ <a href="forgotUserPassword" class="pull-right sub-link">##header.login.password.forget@@</a>
						</h4>
						<div class="form-group">
