      ...
      <div class="col-xs-12 col-sm-4 col-md-4 pad-none ">
        <div class="recent-work-wrap wrap  text-center">
          <div class="recent-work-inner"> <img src="<%=request.getContextPath()%>/resources/images/time.png" alt=""  />
            <div class="recent-work-title"><fmt:message key="flight.main.highlight1.heading.line1" bundle="${msg}" /><br>
              <fmt:message key="flight.main.highlight1.heading.line2" bundle="${msg}" /></div>
            <p>
      ...
      <div class="col-xs-12 col-sm-4 col-md-4 pad-none ">
        <div class="recent-work-wrap-mid wrap  text-center">
          <div class="recent-work-inner less-padding-orange"> <img src="<%=request.getContextPath()%>/resources/images/secure.png" alt=""  />
            <div class="recent-work-title"><fmt:message key="flight.main.highlight2.heading.line1" bundle="${msg}" /><br>
              <fmt:message key="flight.main.highlight2.heading.line2" bundle="${msg}" /></div>
      ...
      <div class="col-xs-12 col-sm-4 col-md-4 pad-none ">
        <div class="recent-work-wrap wrap  text-center">
          <div class="recent-work-inner"> <img src="<%=request.getContextPath()%>/resources/images/rewards.png" alt=""  />
             <div class="recent-work-title"><fmt:message key="flight.main.highlight3.heading.line1" bundle="${msg}" /><br>
              <fmt:message key="flight.main.highlight3.heading.line2" bundle="${msg}" /></div>
