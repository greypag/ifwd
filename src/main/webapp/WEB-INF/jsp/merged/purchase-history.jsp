...
<!-- 								</tr> -->
								...
								<tr>
									...
									<td class="pad-none">
									    <h2 class="black-bold ">${purchaseHistory.policies }</h2>
									</td>
									<td class="pad-none">
									    <h2 class="black-bold ">${accountBalance.accountBalances }</h2>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td class="pad-none h4-5"><fmt:message key="member.account.purchaseHistory.travelCare.label.datePurchase" bundle="${msg}" /> <br></td>
