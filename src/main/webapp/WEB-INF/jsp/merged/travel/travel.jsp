	      ...
	      <div class="col-lg-12 col-md-12 pad-none-lg slide-form">
	        <!-- <h2><fmt:message key="travel.main.quote.top.heading" bundle="${msg}" /></h2> -->
	              ...
	              <tbody>
	               ...
	               <td class="">
	                <button type="submit" class="border-radius btn btn-primary get-btn btn-color-ylw" style="line-height:32px;padding: 8px 20px !important;width: 100%;" onclick="reset_desktop_submit()">
...
<!--     </span> -->
  ...
  <div class="form-container">
    <h3 class="text-center"> 
      ...
      <button type="submit" onclick="reset_mobile_submit()" class="bdr-curve btn btn-primary btn-lg btn-block btn-color-ylw">
              <fmt:message key="travel.main.quote.top.action" bundle="${msg}" /> 
             </button>
    </h3>
  </div>
...
<div class="other-benefits col-lg-12 col-md-12 col-sm-12 col-xs-12">
  ...
  <li>
    ...
    <li>
      ...
      <p id="annual_benefit_club" class="h4-5" style="display:none;"><fmt:message key="annual.main.other.benefit.desc8.part1" bundle="${msg}" /> <a href="<fmt:message key="theclub.link" bundle="${msg}" />" target="_blank"><fmt:message key="annual.main.other.benefit.desc8.part2" bundle="${msg}" /></a> <fmt:message key="annual.main.other.benefit.desc8.part3" bundle="${msg}" /> <a href="<fmt:message key="theclub.clubpoint.link" bundle="${msg}" />" target="_blank"><fmt:message key="annual.main.other.benefit.desc8.part4" bundle="${msg}" /></a> <fmt:message key="annual.main.other.benefit.desc8.part5" bundle="${msg}" /></p>
    </li>
    <li>
        ...
        <table class="table activation-form3">
          ...
          <tr class="hide-html">
            ...
            <tr>
              ...
              <td class="">
                  <button type="submit" onclick="reset_bottom_submit()" class="border-radius btn btn-primary get-btn btn-color-ylw" style="line-height:32px;padding: 8px 20px !important;width: 100%;"><fmt:message key="travel.main.quote.bottom.action" bundle="${msg}" /></button>
                 </td>
            </tr>
            <tr class="product-landing-error-wrap">
