	...
	<div id="cn" class="container">
		<div class="row">
			<form name="paymentForm" id="paymentForm" method="post"
				onsubmit="return payValid();">
				<ol class="breadcrumb pad-none">
					<li><a href="#"><fmt:message
								key="travel.breadcrumb1.item1" bundle="${msg}" /></a> <i
						class="fa fa-caret-right"></i></li>
					<li><a href="#"><fmt:message
								key="travel.breadcrumb1.item2" bundle="${msg}" /></a> <i
						class="fa fa-caret-right"></i></li>
					<li><a href="#"><span class="clearfix"></span> <fmt:message
								key="travel.breadcrumb1.item3" bundle="${msg}" /></a><i
						class="fa fa-caret-right"></i></li>
					<li><a href="#"><fmt:message
								key="travel.breadcrumb1.item4" bundle="${msg}" /></a></li>
					<li class="active "><i class="fa fa-caret-right"></i> <fmt:message
							key="travel.breadcrumb1.item5" bundle="${msg}" /></li>
				</ol>
				<div class="container ">
					<div class="col-md-12 shop-tracking-status">
						<div class="center wow fadeInDown animated"
							...
							<h2>
								<fmt:message key="travel.summary.jumbo" bundle="${msg}" />
							</h2>
						</div>
						<br>
						<div class="col-lg-12">
								...
								<div class="order-status has-four">
									...
									<div
										...
										<span class="status lst-status"> <fmt:message
												key="travel.breadcrumb2.item4" bundle="${msg}" /></span>
					...
					<div
						...
						<div class="col-xs-12 col-md-7  pad-none">
							<h3 class="margin-left-2 h2-3-existing-fwd-head">
								<fmt:message key="travel.summary.heading" bundle="${msg}" />
							</h3>
							<table
								class="table activation-form margin-left-2 vert-middle travel-summary">
								<tbody>
									<tr>
										<td class="h2-1 pad-none"><fmt:message
												key="travel.summary.requestNo" bundle="${msg}" /></td>
										<td class="pad-none h4-5 ">${createPolicy.getReferenceNo()}</td>
									</tr>

									<tr>
										<td></td>
										<td class="h2-1 pad-none">${selectPlanName}<fmt:message
												key="travel.summary.plan" bundle="${msg}" /></td>
                        ...
                        <h4 class="h4-4-full">+ [承保範圍]</h4>
									...
									<tr>
										<td class="h2-1 pad-none"><fmt:message
												key="travel.summary.insuredNo" bundle="${msg}" /> <br>
										</td>
										<td class="pad-none h4-5 ">${travelBean.getTotalTraveller()}</td>
									</tr>
									<tr>
										<td class="h2-1 pad-none"><fmt:message
												key="travel.summary.period" bundle="${msg}" /></td>
									...
									<tr>
										<td class="h2-1 pad-none"><fmt:message
												key="travel.summary.days" bundle="${msg}" /></td>
										<td class="pad-none h4-5 ">${totalTravallingDays}</td>
									</tr>

									<tr>
										<td class="h2-1 pad-none "><fmt:message
												key="travel.summary.applicant.name" bundle="${msg}" /></td>
										<td class="pad-none h4-5 ">${userDetails.getFullName() }</td>
									</tr>
									<tr>

										<td class="h2-1 pad-none "><fmt:message
												key="travel.summary.applicant.hkid" bundle="${msg}" /></td>
										<td class="pad-none h4-5 ">${userDetails.getHkid()}</td>
									</tr>
									<tr>
										<td class="h2-1 pad-none "><fmt:message
												key="travel.summary.applicant.email" bundle="${msg}" /></td>
										<td class="pad-none h4-5 ">${userDetails.getEmailAddress() }</td>
									</tr>
									<tr>
										<td class="h2-1 pad-none "><fmt:message
												key="travel.summary.applicant.mobileNo" bundle="${msg}" /></td>
										<td class="pad-none h4-5 ">${userDetails.getMobileNo() }</td>
									</tr>
									<tr>
										<td class="pad-none"><span class="h4-4-orange-b pad-none"><fmt:message
													key="travel.summary.amountDue" bundle="${msg}" /> </span></td>
										<td class="pad-none "><span
											class="h4-4-orange-b pad-none"><fmt:message
													key="travel.dollar" bundle="${msg}" /> ${dueAmount} </span></td>
									</tr>
								</tbody>
							</table>
						</div>

						<div class="col-md-5 pad-none pull-right hidden-sm hidden-xs">
							<h4 class="h4-trav-full col-xs-offset-8">
								<a
									href="<%=request.getContextPath()%>/travel-insurance/user-details"><fmt:message
										key="travel.summary.subheading" bundle="${msg}" /></a>
							</h4>
						...
						<div id="no-more-tables2">
							<div class="col-xs-12 col-sm-12">
								<div class="travel-tb-td hidden-md hidden-lg text-left wd2">
									<h3 class="color4 h2-1 insur padding-t">
										<fmt:message key="travel.summary.insured" bundle="${msg}" />
									</h3>
								...
								%>
										...
										%>
										<tr>
											<td class="col-xs-12"><table class="col-xs-12">
													<tbody>
														<tr>
															<td>&nbsp;</td>
														</tr>
							...
							<table class="col-md-12 table-condensed cf pad-left-20 beneList ">
								...
								<tbody>
									<tr class="travel-tb-head">
										<td class=" h2-1  travel-tb-td"><fmt:message
												key="travel.summary.insured" bundle="${msg}" /></td>
										<td class=" h2-1  travel-tb-td"><fmt:message
												key="travel.summary.insured.name" bundle="${msg}" /></td>
										<td class=" h2-1  travel-tb-td"><fmt:message
												key="travel.summary.insured.age" bundle="${msg}" /></td>
										<td class=" h2-1  travel-tb-td"><fmt:message
												key="travel.summary.insured.hkid" bundle="${msg}" /></td>
										<td class=" h2-1  travel-tb-td"><fmt:message
												key="travel.summary.insured.beneficiary.relation"
												bundle="${msg}" /></td>
									</tr>
									<%
									...
									<tr class="hidden-sm hidden-xs">
										<td class="pad-none" data-title="Adult <%=i + 1%>"><span
											class="h2-1-td"><fmt:message
													key="travel.summary.insured.label.family.parent"
													bundle="${msg}" /> <%=i + 1%></span></td>
								...
								%>
								<tr>
									<td data-title="Child <%=i + 1%>"><span class="h2-1-td"><fmt:message
												key="travel.summary.insured.label.family.child"
												bundle="${msg}" /> <%=i + 1%></span></td>
									...
									<td class="h4-5" data-title="Relationship"></td>
									<!-- hide relationship if insured -->
								</tr>
								<%
									if (planDetailsForm.getChildBenificiaryFullName().length > 0) {
								...
								<tbody>
									<tr class="hidden-sm hidden-xs">
										<td data-title="Other<%=i + 1%>"><span class="h2-1-td"><fmt:message
													key="travel.summary.insured.label.family.others"
													bundle="${msg}" /> <%=i + 1%></span></td>
				...
				<div class="gray-bg1 pad20">
					...
					<h2 class="from-control">
						<fmt:message key="travel.payment" bundle="${msg}" />
					</h2>
						...
						<tbody>
							<tr class="control-group">
								<td class="col-lg-4 ht1"><label class="control-label h4-5"><fmt:message
											key="travel.payment.card.type" bundle="${msg}" /></label></td>
							...
							<tr style="display: none;">
								<td><label class="control-label h4-5">Payment
										Method</label></td>
								<td colspan="2">
									<div class="controls">
										<label class="radio-inline"> <input type="radio"
											name="pMethod" checked="checked" value="VISA" id="chkVisa">
											VISA
										</label> <label class="radio-inline"> <input type="radio"
											name="pMethod" value="Master" id="chkMaster">
											MasterCard
										</label>
									</div> <!-- <input type="radio" name="pMethod" value="Diners">Diners
							...
							<tr class="control-group">
								<td class="col-lg-4 ht1"><label class="control-label h4-5"><fmt:message
											key="travel.payment.card.no" bundle="${msg}" /></label></td>
								<td colspan="2">
									<div class="controls">
<<<<<<< .mine=======
...
>>>>>>> .theirs											
							...
							<tr class="control-group">
								<td class="col-lg-4 ht1"><label class="control-label  h4-5"><fmt:message
											key="travel.payment.card.expiryDate" bundle="${msg}" /></label></td>
							...
							<tr class="control-group">
								<td class="col-lg-4 ht1"><label class="control-label  h4-5"><fmt:message
											key="travel.payment.card.holderName" bundle="${msg}" /></label></td>
								<td colspan="2">
									<div class="controls">
							...
							<tr class="control-group">
								<td class="col-lg-4 ht1"><label class="control-label  h4-5"><fmt:message
											key="travel.payment.card.cvv" bundle="${msg}" /></label></td>
								<td>
									<div class="controls">
					...
					<div class="declaration-content margin-left-small">
						<div class="checkbox">
							<input id="checkbox3" type="checkbox"> <label
								for="checkbox3"> <fmt:message
									key="travel.payment.declarations" bundle="${msg}" /></label>
						</div>
						...
						<div class="hidden-sm hidden-xs pad-none">
							<a
								href="<%=request.getContextPath()%>/flight-insurance/user-details"
								class="bdr-curve btn btn-primary bck-btn2"><fmt:message
									key="travel.action.back" bundle="${msg}" /> </a>
							<button onclick="confirmPayment();"
								class="bdr-curve btn btn-primary nxt-btn margin-left">
								<fmt:message key="travel.action.payment" bundle="${msg}" />
							</button>
						</div>
						<br> <br>
						<div class="row hidden-md hidden-lg">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pull-left">
								<a
									href="<%=request.getContextPath()%>/travel-insurance/user-details"
