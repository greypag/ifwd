...
<section>
	<div id="cn" class="container">
		<div class="row">
			<form:form name="frmTravelPlan" id="frmTravelPlan" action="${pageContext.request.contextPath}/${language}/travel-insurance/user-details"
			method="post" modelAttribute="travelQuote" onsubmit="return chkDueAmount();" >
