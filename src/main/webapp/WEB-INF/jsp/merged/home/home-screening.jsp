     ...
     <div class="app-pg-cont">
        ...
        <div class="container-fluid">
            ...
            <div class="screening-wrapper clearfix">
                <img src="<%=request.getContextPath()%>/resources/images/easy-home/${plan=='home-liability'? 'screening_image_v01.png' : 'screening_image_v02.png' }" alt="" class="img-hero hidden-xs">
                <img src="<%=request.getContextPath()%>/resources/images/easy-home/${plan=='home-liability'? 'screening_image_mobile_v01.png' : 'screening_image_mobile_v02.png' }" alt="" class="img-responsive visible-xs">
