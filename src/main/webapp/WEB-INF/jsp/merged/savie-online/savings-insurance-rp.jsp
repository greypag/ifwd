       ...
       <div class="savie-regular-container savie-regular-landing">
       	...
       	<div class="payment-mode">
       		<div class="desktop-inline">
        		<div class="payment-inline">
	        		...
	        		<div class="payment-options clearfix">
	        			...
	        			<div class="right">
	        				<button id="one-off-button"><fmt:message key="label.savie.premium" bundle="${msg}" /></button>
	        			</div>
	        		</div>
	        	</div>
        	</div>
        	...
        	<div class="hidden-xs hidden-sm">
        		<h3 class="benefits-desktop text-center"><fmt:message key="eliteTerms.landing.Benefits" bundle="${msg}" /></h3>
        		<div class="gray-divide"></div>
        	</div>
						...
						<div class="tab-content carousel-inner clearfix" role="listbox">
							<div role="tabpanel" class="fna-tab-content tab-pane item active" id="navtabs-1">
								<div class="so-fna-content">
									...
									<h3 class="visible-md visible-lg  tab-head"><fmt:message key="Overseas.Landing.Platformpillar1.headline" bundle="${msg}" /></h3>
									 <p><fmt:message key="Overseas.Landing.Platformpillar1.copy1" bundle="${msg}" /></p>
								</div>
							</div>
							...
							<div role="tabpanel" class="fna-tab-content tab-pane item" id="navtabs-4">
								<div class="so-fna-content">
									...
									<p><fmt:message key="eliteTerms.landing.eServices.App" bundle="${msg}" /> <a href="#" class="eserv-link ui-link"><fmt:message key="savierp.landing.presentation.eservice.content2" bundle="${msg}" /></a> <fmt:message key="savierp.landing.presentation.eservice.content3" bundle="${msg}" /></p>
								</div>
							</div>
						</div>
						<!-- Carousel -->
