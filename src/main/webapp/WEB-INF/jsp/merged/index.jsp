						  ...
						  <div class="psa-content">
							...
							<div class="psa-link-content">
								...
								<ul class="psa-ul">
									...
									<li><a href="<fmt:message key="link.category.oversea.study" bundle="${msg}" />"><fmt:message key="navbar.category1.group2.item3" bundle="${msg}" /> <i class="fa fa-caret-right orange-caret-right"></i></a></li>
