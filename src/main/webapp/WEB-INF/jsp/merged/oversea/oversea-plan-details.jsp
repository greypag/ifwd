                        ...
                        <div class="form-wrap">
                           ...
                           <div class="form-group float">
                               ...
                               <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
                                   <input autocomplete="off" type="text" name="fullName" class="js-field-fullname form-control full-control textUpper <c:if test="${!(userDetails != null && userDetails.fullName != '' && userDetails.userName != '*DIRECTGI')}">bmg_custom_placeholder</c:if>" id="inputFullName" 
                                   <c:choose>
                           ...
                           <div class="form-group float">
                               ...
                               <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
                                   <input autocomplete="off" type="text" name="hkid" class="js-field-hkid form-control numberinput textUpper full-control bmg_custom_placeholder" id="inputTxtAppHkid"
                           ...
                           <div class="form-group float">
                               ...
                               <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
                                    <input autocomplete="off" name="mobileNo" type="tel" class="js-field-mobile form-control full-control <c:if test="${!(userDetails != null && userDetails.fullName != '' && userDetails.userName != '*DIRECTGI')}">bmg_custom_placeholder</c:if>" 
                                       <c:choose>
                                ...
                                <!--<div class="personaltraveller">-->
                                    ...
                                    <!--<div>-->
                                       ...
                                       <div class="form-group float">
                                           ...
                                           <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
                                                  <input autocomplete="off" type="text" id="txtInsuFullName1" name="personalName" class="js-field-fullname form-control full-control textUpper <c:if test="${!(userDetails != null && userDetails.fullName != '' && userDetails.fullName != '*DIRECTGI')}">bmg_custom_placeholder</c:if>"
                                                      <c:choose>
                                                          <c:when test="${userDetails != null && userDetails.fullName != '' && userDetails.userName != '*DIRECTGI'}">
                                                          value="${userDetails.fullName }" readonly="readonly"
                                                          </c:when>
...
<%--                                                     <input name="insuredDob" type="text" class="pointer datepicker form-control border-radius" id="insuredDob" onfocus="placeholderOnFocus(this,<fmt:message key="Overseas.userdetails.Insured.DOB" bundle="${msg}" />);" onblur="placeholderOnBlur(this,<fmt:message key="Overseas.userdetails.Insured.DOB" bundle="${msg}" />);" placeholder="<fmt:message key="Overseas.userdetails.Insured.DOB" bundle="${msg}" />" value="" readonly> --%>
                                ...
                                <div class="form-wrap">
                                    ...
                                    <div class="form-group auto-complete">
                                        ...
                                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
                                            <input autocapitalize="none" autocomplete="off" name="countryOfInstitution" type="text" class="js-field-fullname form-control full-control bmg_custom_placeholder" value="<fmt:message key="Overseas.userdetails.Instituation.Country" bundle="${msg}" />" id="countryOfInstitution" onfocus="placeholderOnFocus(this,'<fmt:message key="Overseas.userdetails.Instituation.Country" bundle="${msg}" />');" onblur="placeholderOnBlur(this,'<fmt:message key="Overseas.userdetails.Instituation.Country" bundle="${msg}" />');validatecountryOfInstitution();" onkeypress="return isAlphaNumeric(event);" maxlength="50">                                              
                                    ...
                                    <div class="form-group float clear-float">
                                        ...
                                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
                                            <input autocomplete="off" name="nameOfInstitution" type="text" class="js-field-fullname form-control full-control bmg_custom_placeholder" value="<fmt:message key="Overseas.userdetails.Instituation.Name" bundle="${msg}" />" id="nameOfInstitution" onfocus="placeholderOnFocus(this,'<fmt:message key="Overseas.userdetails.Instituation.Name" bundle="${msg}" />');" onblur="placeholderOnBlur(this,'<fmt:message key="Overseas.userdetails.Instituation.Name" bundle="${msg}" />');validatenameOfInstitution();" onkeypress="return isAlphaNumeric(event);" maxlength="100"> 
                                    ...
                                    <div class="form-group float">
                                        ...
                                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
                                            <input autocomplete="off" name="addressofInstitutionLine1" type="text" class="js-field-address form-control full-control bmg_custom_placeholder" value="<fmt:message key="Overseas.userdetails.Instituation.Line1" bundle="${msg}" />" id="addressofInstitutionLine1" onkeypress="return isAlphaNumericWithSpecialChar(event);"  onfocus="placeholderOnFocus(this,'<fmt:message key="Overseas.userdetails.Instituation.Line1" bundle="${msg}" />');" onblur="placeholderOnBlur(this,'<fmt:message key="Overseas.userdetails.Instituation.Line1" bundle="${msg}" />');validateaddressofInstitutionLine()" maxlength="29"> 
                                        </div>
                                    </div>
                                    <div class="form-group float">
                                        <div class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
