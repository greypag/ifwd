										...
										success : function(data) {
											...
											if (data == 'success') {
												...
												if (data == 'This username already in use, please try again') {
													$('.error-hide')
															.html(
																	'<fmt:message key="member.registration.fail.username.registered" bundle="${msg}" />');
												} else if (data == 'email address and mobile no. already registered') {
													$('.error-hide')
															.html(
																	'<fmt:message key="member.registration.fail.emailMobile.registered" bundle="${msg}" />');
												} else {
...
<section class="product_header_path_container ">
	<div class="container">
		<div class="product_header_path_item back">
			<i class="fa fa-arrow-left"></i>
			<div class="partition"></div>
		</div>
		<div class="product_header_path_item hidden-sm hidden-xs">Plan
			Options</div>
		<div class="product_header_path_item active">Application</div>
		<div class="product_header_path_item hidden-sm hidden-xs">
			Payment
			<div class="partition"></div>
		</div>
...
<section>
	<div id="cn" class="container">
		<div class="row">
			<form:form id="frmYourDetails" name="frmYourDetails"
				onsubmit="return validateOverseaDetails(this,'frmYourDetails','${language}');"
				modelAttribute="frmYourDetails" method="post" action="">
				<ol class="breadcrumb pad-none">
					<li><a href="#"><key
								id='Overseas.Landing.Breadcrumb.layer1'>Home</key></a> <i
						class="fa fa-caret-right"></i></li>
					<li><a href="#"><key
								id='Overseas.Landing.Breadcrumb.layer2'>Protect</key></a></li>
					<i class="fa fa-caret-right"></i>
					</li>
					<li><a href="#"><key
								id='Overseas.Landing.Breadcrumb.layer3'>Overseas
							StudentCare Insurance</key></a></li>
					<li class="active "><i class="fa fa-caret-right"></i>
					<key id='Overseas.Landing.Breadcrumb.step3'>Your details</key></li>
				</ol>
				...
				<div class="product_plan_details_member_title white-bg1">
					<h3
						class="pull-left h2-3-existing-fwd-head bmg-detail-exist-member-head">
						<fmt:message key="annual.common.member" bundle="${msg}" />
					</h3>
					<div class="pull-left">
						<a href="#" class="pull-left btn-box-2 color4 login-btn"
							data-toggle="modal" data-target="#loginpopup"><fmt:message
								key="annual.common.login" bundle="${msg}" /></a>
						<div class="pull-left text-left">
							<h3 class="text-left or-continue">
								<span style="margin-left: 10px; margin-right: 10px;"><fmt:message
										key="annual.common.or" bundle="${msg}" /></span>
				...
				<div id="quote-wrap"
					...
					<div
						class="col-lg-8 col-md-8 col-sm-12 col-xs-12 pad-none white-bg1">
						<br>
						...
						<div class="form-wrap">
							...
							<div class="form-group float">
								<div
									...
									<label for="inputFullName" class="field-label bold-500"><key
											id='Overseas.userdetails.applicant.Fullname'>Full name</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input type="text" name="fullName"
										class="form-control full-control textUpper bmg_custom_placeholder"
										id="inputFullName" value="SAME AS ID DOCUMENT"
										onfocus="placeholderOnFocus(this,'SAME AS ID DOCUMENT');"
										onblur="placeholderOnBlur(this,'SAME AS ID DOCUMENT'); validateName('inputFullName','fullnameinvalid',true,'applicant');"
										onkeypress="return alphaOnly(event);" maxlength="50">
									<!-- <key id='Overseas.userdetails.applicant.Fullname.Same'>SAME AS ID DOCUMENT</key> -->
							...
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label class="field-label bold-500"> <key
											id='Overseas.userdetails.applicant.HKID'>HKID</key> <input
										type="hidden" name="selectedHkidPassApplicant"
										id="selectHkidPass" value="HKID">
									</label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input type="text" name="hkid"
										...
										id="inputTxtAppHkid"
										onkeypress=" return hkidOnkeypress(event);" value=""
										onfocus="placeholderOnFocus(this,'EG: X1234567 WITHOUT ()');"
										onblur="placeholderOnBlur(this,'EG: X1234567 WITHOUT ()'); validateHkid('inputTxtAppHkid','selectHkidPass','errAppHkid',true,'applicant');">
									<!-- <key id='Overseas.userdetails.applicant.HKID.eg'>EG: X1234567 WITHOUT ()</key> -->
							...
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label for="inputApplicantDob" class="field-label bold-500"><key
											id='Overseas.userdetails.applicant.DOB'>Date of birth</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<div class="input-group date" id="input_oversea_dob">
										<span class="input-group-addon in border-radius"><img
											src="<%=request.getContextPath()%>/resources/images/calendar.png"
											alt=""></span> <input name="applicantDob" type="text"
											class="pointer datepicker form-control border-radius"
											id="applicantDob" value="" readonly>
									</div>
							...
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label for="inputMobileNo" class="field-label bold-500"><key
											id='Overseas.userdetails.applicant.Mobile'>Mobile no.</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input name="mobileNo" type="tel"
										class="form-control full-control" value="" id="inputMobileNo"
										onkeypress="return isNumeric(event)"
										onblur="replaceNumeric(this); validateMobile('inputMobileNo','errMobileNo');"
										maxlength="8">
									<!-- <key id='Overseas.userdetails.applicant.Mobile.number'>Mobile no.</key> -->
							...
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label for="inputEmailId" class="field-label bold-500"><key
											id='Overseas.userdetails.applicant.Email'>Email address</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input class="form-control full-control textLower"
										name="emailAddress" type="email" value="" id="inputEmailId"
										maxlength="50"
										onblur="validateEmail('inputEmailId','emailid');"> <span
										id="emailid" class="text-red"></span>
									<!-- <key id='Overseas.userdetails.applicant.Email.Error.Empty'>Please enter your email address.</key> -->
								</div>
							</div>
							<!-- email address ends -->
						</div>
						...
						<div class="form-group float">
							<div
								class="form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
								<label class="field-label bold-500"><key
										id='Overseas.userdetails.applicant.Relationship'>Relationship
						...
						<div class="form-wrap">
							...
							<div class="big-title black-bold pad-none bmg-big-title">
								<key id='Overseas.userdetails.applicant.Correspondence'>Correspondence
								address</key>
							</div>
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label for="inputRoomId" class="field-label bold-500"><key
											id='Overseas.userdetails.applicant.Correspondence.ROOM'>ROOM</key></label>
									/ <label for="inputFloorId" class="field-label bold-500"><key
											id='Overseas.userdetails.applicant.Correspondence.FLOOR'>FLOOR</key></label>
									/ <label for="inputBlockId" class="field-label bold-500"><key
											id='Overseas.userdetails.applicant.Correspondence.BLOCK'>BLOCK</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<div class="col-sm-6 col-xs-6 col-lg-6 col-md-6 pad-none">
										<input
											class="col-lg-12 col-md-12 col-xs-12 col-sm-12 floor-block-grp full-control textLower"
											name="correspondenceAddressRoom" size=10 type="" value=""
											id="correspondenceAddressRoomId" maxlength="50" onblur=""><span
											id="" class="text-red"></span>
									</div>
									<div
										class="col-sm-3 col-xs-3 col-lg-3 col-md-3 floor-block-pad-right-none">
										<input
											class="col-lg-12 col-md-12 col-xs-12 col-sm-12 floor-block-grp full-control textLower"
											name="correspondenceAddressFloor" size=1 type="" value=""
											id="correspondenceAddressFloorId" maxlength="50" onblur=""><span
											id="" class="text-red"></span>
									</div>
									<div
										class="col-sm-3 col-xs-3 col-lg-3 col-md-3 floor-block-pad-right-none">
										<input
											class="col-lg-12 col-md-12 col-xs-12 col-sm-12 floor-block-grp full-control textLower"
											name="correspondenceAddressBlock" size=1 type="" value=""
											id="correspondenceAddressBlockId" maxlength="50" onblur=""><span
											id="" class="text-red"></span>
									</div>
								</div>
							</div>
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label for="inputBuildingId" class="field-label bold-500"><key
											id='Overseas.userdetails.applicant.Correspondence.BUILDING'>BUILDING</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input class="form-control full-control textLower"
										name="correspondenceAddressBuilding" type="" value=""
										id="correspondenceAddressBuildingId" maxlength="50"
										onblur="validateCorrespondenceBorE();"><span id=""
										class="text-red"></span>
								</div>
							</div>
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label for="inputEstateId" class="field-label bold-500"><key
											id='Overseas.userdetails.applicant.Correspondence.ESTATE'>ESTATE</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input class="form-control full-control textLower"
										name="correspondenceAddressEstate" type="" value=""
										id="correspondenceAddressEstateId" maxlength="50"
										onblur="validateCorrespondenceBorE();"><span
										id="errorEmptyCorrespondenceAddressEstate" class="text-red"></span>
								</div>
							</div>
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label for="inputStreetNoId" class="field-label bold-500"><key
											id='Overseas.userdetails.applicant.Correspondence.STREETNO'>Street
										No.</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input class="form-control full-control textLower"
										name="correspondenceAddressStreetNo" type="" value=""
										id="correspondenceAddressStreetNoId" maxlength="50" onblur=""><span
										id="" class="text-red"></span>
								</div>
							</div>
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label for="inputStreetNameId" class="field-label bold-500"><key
											id='Overseas.userdetails.applicant.Correspondence.STREETNAME'>STREET
										NAME</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input class="form-control full-control textLower"
										name="correspondenceAddressStreetName" type="" value=""
										id="correspondenceAddressStreetNameId" maxlength="50"
										onblur=""><span id="" class="text-red"></span>
								</div>
							</div>
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label for="inputDistrictId" class="field-label bold-500"><key
											id='Overseas.userdetails.applicant.Correspondence.District'>District</key></label>
								</div>
								<div
									class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none district-btn-grp">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 pad-none">
										<input type="radio" name="districtSelected"
											...
											id="inlineCARadio3" onclick="" maxlength="50" onblur=""><span
											id="" class="text-red"></span> <label for="inputDistrictId"
											class="field-label bold-500"><key
												id='Overseas.userdetails.applicant.HongKong'>HK</key></label>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 pad-none">
										<input type="radio" name="districtSelected"
											name="correspondenceAddressDistrict" type="" value="KL"
											id="inlineCARadio4" onclick="" maxlength="50" onblur=""><span
											id="" class="text-red"></span> <label for="inputDistrictId"
											class="field-label bold-500"><key
												id='Overseas.userdetails.applicant.Kowloon'>KL</key></label>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 pad-none">
										<input type="radio" name="districtSelected"
											name="correspondenceAddressDistrict" type="" value="NT"
											onclick="" id="inlineCARadio5" maxlength="50" onblur=""><span
											id="" class="text-red"></span> <label for="inputDistrictId"
											class="field-label bold-500"><key
												id='Overseas.userdetails.applicant.NT'>N.T.</key></label>
									</div>
								</div>
								<div class="hidden">
							...
							<div class="form-group float">
								<div
									class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none pull-right">
									<div id="applicantDistrictSelect" class="styled-select">
							...
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none"></div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<span id="errorEmptycorrespondenceAddressDistrict"
										class="text-red"></span>
								</div>
						...
						<input type="hidden" name="totalPersonalTraveller"
							id="totalPersonalTraveller" value="1">
...
<<<<<<< HEAD
							...
							<div class="form-group float">
								<div
									class="form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label class="field-label bold-500"><key
											id='Overseas.userdetails.Insured.Fullname'>Full name</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input type="text" id="txtInsuFullName1" name="personalName"
										class="form-control full-control textUpper bmg_custom_placeholder"
										value="SAME AS ID DOCUMENT"
										onfocus="placeholderOnFocus(this,'');"
										onblur="placeholderOnBlur(this,''); validateName('txtInsuFullName1','errtxtPersonalFullName1',false,'insured');"
										onkeypress="return alphaOnly(event);" maxlength="100"
										readonly="readonly"> <span
										id="errtxtPersonalFullName1" class="text-red"></span>
								</div>
							</div>
							<!-- english name end -->
							<!-- id card start -->
							<div class="form-group float">
								<div
									class="form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label class="field-label bold-500"><key
											id='Overseas.userdetails.Insured.HKID'>HKID</key></label> <input
										id="selectedPersonalHkidPass1" name="selectedPersonalHkidPass"
										value="HKID" type="hidden">
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input id="txtInsuHkid1" name="personalHKID"
										class="form-control textUpper full-control bmg_custom_placeholder"
										value="EG: X1234567 WITHOUT ()"
										onkeypress=" return hkidOnkeypress(event);"
										onfocus="placeholderOnFocus(this,'HKID/PASSPORT NO.');"
										onblur="placeholderOnBlur(this,'HKID/PASSPORT NO.'); validateHkid('txtInsuHkid1','selectedPersonalHkidPass1','errtxtInsuHkid1',false,'insured');"
										readonly="readonly">
									<!-- <key id='Overseas.userdetails.Insured.HKID.eg'>EG: X1234567 WITHOUT ()</key> -->
							...
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label for="inputApplicantDob" class="field-label bold-500"><key
											id='Overseas.userdetails.Insured.DOB'>Date of birth</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<div class="input-group date" id="oversea_insure_dob">
										<span class="input-group-addon in border-radius"><img
											src="<%=request.getContextPath()%>/resources/images/calendar.png"
...
<<<<<<< HEAD
							...
							<div class="form-group float">
								...
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<div class="styled-select">
										<select name="personalBeneficiary"
											id="personalselectBenificiary1"
											onchange="activeDiv('personalbenificiaryId1','personalselectBenificiary1', 'personalBenefitiaryId1', 'personalBenefitiaryHKId1')"
											class="form-control soflow select-label">
											<option value="SE"><key
													id='Overseas.userdetails.Bene.Option1'>Own estate</key></option>
											<option value="CH"><key
													id='Overseas.userdetails.Bene.Option2'>Child</key></option>
											<option value="FM"><key
													id='Overseas.userdetails.Bene.Option3'>Fiance</key></option>
											<option value="FF"><key
													id='Overseas.userdetails.Bene.Option4'>Fiancee</key></option>
											<option value="GC"><key
													id='Overseas.userdetails.Bene.Option5'>Grand Parent
												&amp; Grand Child</key></option>
											<option value="PA"><key
													id='Overseas.userdetails.Bene.Option6'>Parent</key></option>
											<option value="SL"><key
													id='Overseas.userdetails.Bene.Option7'>Sibling</key></option>
											<option value="SP"><key
...
>>>>>>> cf2c641a34cba07ed886d7c19c9f05511c40b7b5
							...
							<div class="form-group float hide" id="personalbenificiaryId1">
								...
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									...
									<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 pad-none">
										<input type="text" name="personalBenificiaryFullName"
											id="personalBenefitiaryId1"
											class="form-control full-control textUpper bmg_custom_placeholder"
											value="SAME AS ID DOCUMENT"
											onfocus="placeholderOnFocus(this,'');"
											onblur="placeholderOnBlur(this,''); validateName('personalBenefitiaryId1','errpersonalBenefitiaryId1',false,'beneficiary');"
											onkeypress="    return alphaOnly(event);" maxlength="100"></input>
										<!-- <key id='Overseas.userdetails.Bene.Fullname.Same'>SAME AS ID DOCUMENT</key> -->
										<span id="errpersonalBenefitiaryId1" class="text-red">
										</span>
									</div>
									<div class="clearfix"></div>
								</div>
							...
							<div class="form-group float hide" id="personalbenificiaryId1b">
								...
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<div
										class="form-label col-lg-5 col-md-5 col-sm-5 col-xs-5 pad-none">
										<label class="field-label form-label bold-500"> <key
												id='Overseas.userdetails.Bene.HKID'>HKID / Passport No</key>
										</label>
									</div>
									<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 pad-none">
										<div class="styled-select">
											<select id="selectPersonalBenefitiaryHkidPass1"
												class="form-control soflow select-label"
												name="selectedPersonalBenefitiaryHkidPass"
												onchange="togglePlaceholder(this,'personalBenefitiaryHKId1','EG: X1234567 WITHOUT ()');">
												<option value="HKID" selected="selected"><key
														id='Overseas.userdetails.Bene.HKID'>HKID</key></option>
												<option value="passport"><key
														id='Overseas.userdetails.Bene.Passport'>Passport no</key></option>
											</select>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									...
									<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 pad-none">
										<input id="personalBenefitiaryHKId1"
											name="personalBenificiaryHkid"
											class="form-control textUpper full-control bmg_custom_placeholder"
											value="EG: X1234567 WITHOUT ()"
											onkeypress=" return hkidOnkeypress(event);"
											onfocus="placeholderOnFocus(this,'EG: X1234567 WITHOUT ()');"
											onblur="placeholderOnBlur(this,'EG: X1234567 WITHOUT ()'); validateHkid('personalBenefitiaryHKId1','selectPersonalBenefitiaryHkidPass1','errpersonalBenefitiaryHKId1',false,'beneficiary');"></input>
										<span id="errpersonalBenefitiaryHKId1" class="text-red">
						...
						<div class="form-wrap">
							<div class="big-title black-bold"
								style="padding-left: 0px !important;">Overseas Educational
						...
						<div class="form-wrap">
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label for="inputOverseasInsuredDob"
										class="field-label bold-500"><key
											id='Overseas.userdetails.Insured.DOB'>Date of birth</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<div class="input-group date" id="input_dob3">
										<span class="input-group-addon in border-radius"><img
											src="<%=request.getContextPath()%>/resources/images/calendar.png"
											alt=""></span> <input name="inputOverseasInsuredDob"
											type="text"
											class="pointer datepicker form-control border-radius"
											id="inputOverseasInsuredDob" value="" readonly="">
									</div>
									<span id="dobOverseasInsuredInvalid" class="text-red"></span>
								</div>
							</div>
							...
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label for="countryOfInstitution" class="field-label bold-500"><key
											id='Overseas.userdetails.Instituation.Country'>Country
										of Institution</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input name="countryOfInstitution" type=""
										class="form-control full-control" value=""
										id="countryOfInstitution" onkeypress="" onblur="validatecountryOfInstitution()"
										maxlength="50"> <br> <span
										id="countryOfInstitutionInvalid" class="text-red"></span>
								</div>
							</div>
							...
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label for="nameOfInstitution" class="field-label bold-500"><key
											id='Overseas.userdetails.Instituation.Name'>Name of
										Institution</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input name="nameOfInstitution" type=""
										class="form-control full-control" value=""
										id="nameOfInstitution" onkeypress="" onblur="validatenameOfInstitution()" maxlength="50">
							...
							<div class="form-group float">
								<div
									class="field-label form-label col-lg-5 col-md-5 col-sm-12 col-xs-12 pad-none">
									<label for="addressofInstitutionLine1"
										class="field-label bold-500"><key
											id='Overseas.userdetails.Instituation.Address'>Address</key></label>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input name="addressofInstitutionLine1" type=""
										class="form-control full-control" value=""
										id="addressofInstitutionLine1" onkeypress=""
										onblur="validateaddressofInstitutionLine()" maxlength="50">
								</div>
							</div>
							<div class="form-group float">
								<div
								...
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input name="addressofInstitutionLine2" type=""
										class="form-control full-control" value=""
										id="addressofInstitutionLine2" onkeypress=""
										onblur="validateaddressofInstitutionLine()" maxlength="50">
								</div>
							</div>
							<div class="form-group float">
								...
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input name="addressofInstitutionLine3" type=""
										class="form-control full-control" value=""
										id="addressofInstitutionLine3" onkeypress=""
										onblur="validateaddressofInstitutionLine()" maxlength="50">
							...
							<div class="form-group">
								<div class="checkbox margin-fix">
									<input id="visacheckbox" name="visacheckbox" type="checkbox" onclick="checkVisaCheckBox(this.checked)">
									<label for="visacheckbox"><key
											id='Overseas.userdetails.TC.ValidVisa'>I have a valid
										Full-time Overseas Student Visa</key></label>
								</div>
							...
							<div class="declaration-content"
								...
								<div class="checkbox">
									...
									<label for="checkbox1"> <key
											id='Overseas.userdetails.TC.TC'>I have read and
										understood the policy provisions and declare that:</key>
										<ol class="ol-disclaimer">
											<li>the particulars and statements given above are, to
												the best of my knowledge and belief, true and complete;</li>
											<li>to the best of my knowledge and belief no Insured
												Person is travelling contrary to the advice of any medical
												practitioner or for the purpose of obtaining medical
												treatment and I understand that treatment of any
												pre-existing, recurring or congenital medical conditions are
												not insured. I am not aware of any condition cause or
												circumstance that may necessitate the cancellation or
												curtailment of the journey as planned;</li>
											<li>this application shall be the basis of the contract
												between me and FWD General Insurance Company Limited;</li>
											<li>this Proposal Form is applied at HKSAR, in case of
												fraud or misrepresentation, the policy may be declared void;</li>
											<li>I have obtained the consent from the Insured
												Person(s) for passing the above information to FWD General
												Insurance Company Limited for the purpose of carrying out
												the TravelCare Insurance.</li>
										</ol>
								...
								<div class="checkbox">
									...
									<label for="checkbox2"> <key
											id='Overseas.userdetails.TC.PICS'>I have read and
										understood <a
											href="http://www.fwd.com.hk/upload/en-US/GI_Personal%20Data%20Protection%20Policy%20and%20Practices.pdf"
											class="sub-link" target="_blank">Personal Information
											Collection Statement</a> and agree to be bound by the same.</key>
								...
								<hr>
								<div>
									<label> <key id='Overseas.userdetails.TC.DoNotWish'>If
										you do NOT wish FWD General Insurance Company Limited to use
										Your Personal Data in direct marketing or provide Your
										Personal Data to other persons or companies for their use in
										direct marketing, please tick the appropriate box(es) below:</key> <br>
									</label>
								</div>
								<div class="checkbox">
									<input id="checkbox3" name="checkbox3" type="checkbox">
									<label for="checkbox3"><key
											id='Overseas.userdetails.TC.DoNotSend'>Please do not
										send direct marketing information to me.</key><br> </label>
								</div>
								<div class="checkbox">
									<input id="checkbox4" name="checkbox4" type="checkbox">
									<label for="checkbox4"> <key
											id='Overseas.userdetails.TC.DoNotProvide'>Please do not
										provide my personal data to other persons or companies for
										their use in direct marketing.</key><br>

									</label>
								</div>

								<div class="checkboxBubble">You may not be able to receive
									our latest promotion and benefits!</div>
						...
						<div class="gray-bg3-wid container membership-wrap"
							...
							<div class="form-wrap">
								<div class="membership-header">
									<h3 class="bmg-membership-header">
										<key id='Overseas.userdetails.Create'>Create FWD member
										account</key>
									</h3>
									<h5>
										<key id='Overseas.userdetails.Create.Enjoy'>Enjoy
										year-round promotions and referral benefits</key>
									</h5>
									<i class="text-grey"><key
											id='Overseas.userdetails.Create.Leave'>Leave blank if
										you do not want to creat a member account</key></i>
									<h3 id="error_hide" class="error-hide"
										style="display: none; color: red; font-size: 15px;"></h3>
								</div>
								<div class="form-group float row">
									<div class="form-label col-lg-5 col-md-5 col-sm-12 col-xs-12">
										<label class="field-label bold-500"><key
												id='Overseas.userdetails.Create.Username'>Choose
											username</key></label>
									</div>
									<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
										<input type="text" name="username"
											class="form-control full-control input-white" id="Username"
											onfocus="emptyMembershipError();"
											onkeypress="return validationUsername(event);"><span
								...
								<div class="form-group float row">
									<div class="form-label col-lg-5 col-md-5 col-sm-12 col-xs-12">
										<label class="field-label bold-500"><key
												id='Overseas.userdetails.Create.Password'>Choose
											password</key></label>
									</div>
									<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
										<input type="password" name="password"
											class="form-control full-control input-white" id="Password"
											autocomplete="off" onfocus="emptyMembershipError();">
								...
								<div class="form-group float row">
									<div class="form-label col-lg-5 col-md-5 col-sm-12 col-xs-12">
										<label class="field-label bold-500"><key
												id='Overseas.userdetails.Create.Confirm'>Confirm
											password</key></label>
									</div>
									<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
										<input type="password"
						...
						<input type="hidden" id="isLogin" value="false"> <input
							type="hidden" id="totalTravellingDays" name="totalTravellingDays"
							value="9">
						...
						<div class="form-wrap" style="margin-bottom: 10px;">
							<h4 class="h4-4 product_landing_download_button pull-left">
								<i class="fa fa-download"></i> <a
									...
									target="_blank">Product Brochure </a>
							</h4>
							<h4 class="h4-4 product_landing_download_button pull-left">
								<i class="fa fa-download"></i> <a
									href="<%=request.getContextPath()%>/resources/policy-provisions-pdf/TravelCare_Provisions_Mar_2015.pdf"
									target="_blank">Policy Provisions </a>
							</h4>
							<div class="clearfix"></div>
						</div>
					</div>
					<div
						class="col-lg-4 col-md-4 col-sm-12 col-xs-12  gray-bg pad-none wht-bg3 floatingbox"
						style="top: 0px;">
						<div class="hidden-sm hidden-xs">
							<div class="wd2">
								<div class="pull-left" style="">
									<h2 class="h2-3-choose"
										style="padding-left: 0px; font-size: 24px; margin-bottom: 0px;">Overseas
										StudentCare Worldwide</h2>
									<h2 class="h2-3-choose"
										style="padding-left: 0px; font-size: 24px; margin-top: 0px;"></h2>
									<h4
										style="padding-left: 0px; line-height: 0px; font-size: 16px;">${planName }</h4>
							...
							<div style="width: 80%; margin-left: 10%;">
								<c:if test="${referralCode!=null && referralCode!=''}">
									<h3 style="margin-bottom: 0px;">
										<fmt:message key="annual.details.promotioncode"
											bundle="${msg}" />
									</h3>
									<h4 class="pad-none"
										style="color: #999; font-size: 22px; margin-top: 0px;">${referralCode}</h4>
								</c:if>
								<h3 class="h4-1-orange-b col-lg-6 col-md-6"
									style="padding-left: 0px; font-size: 18px;">Subtotal</h3>
								<h3 class="h4-1-orange-b col-lg-6 col-md-6 text-right"
									style="padding-right: 0px; font-size: 18px;">${planPremium}
								</h3>
								<h3 class="h4-1-orange-b col-lg-6 col-md-6"
									style="padding-left: 0px; font-size: 18px;">Discount</h3>
								<h3 class="h4-1-orange-b col-lg-6 col-md-6 text-right"
								...
								<div class="top35 pull-right pad-none" style="width: 47%">
									...
									<c:choose>
										<c:when test="${language=='en'}">
											<input type="button"
												onclick="javascript:kenshoo_conv('Registration_Step2','${planSummary}','','Regis_Oversea_Step2 EN','USD');return activateUserAccountJoinUs();"
												class="bdr-curve btn btn-primary nxt-btn"
												value=" <fmt:message key="annual.button.next" bundle="${msg}" />" />
										</c:when>
										<c:otherwise>
											<input type="button"
												onclick="javascript:kenshoo_conv('Registration_Step2','${planSummary}','','Regis_Oversea_Step2 ZH','USD');return activateUserAccountJoinUs();"
												class="bdr-curve btn btn-primary nxt-btn"
												value=" <fmt:message key="annual.button.next" bundle="${msg}" />" />
										</c:otherwise>
									</c:choose>
				...
				<p class="padding1 workingholiday-plan-disclaimer">
					<br>
					<key id='Overseas.userdetails.Disclaimer1'>The feature above
					are indicative only.</key>
					<br>
					<key id='Overseas.userdetails.Disclaimer2'>For a complete
					explanation of the terms and conditions, please contact your
					adviser or our customer service at 3123 3123 for more details.</key>
				</p>
				...
				<div class="col-xs-12 hidden-md hidden-lg pad-none">
					<div style="width: 80%; margin-left: 10%; margin-bottom: 50px;">
						<div class="top35 pull-left pad-none" style="width: 47%">
							<a class="bdr-curve btn btn-primary bck-btn"
								onclick="perventRedirect=false;BackMe();">Back </a>
						</div>
						<div class="top35 pull-right pad-none" style="width: 47%">
...
<link href="<%=request.getContextPath()%>/resources/css/oversea.css"
	rel="stylesheet">
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/js/oversea.js"></script>
