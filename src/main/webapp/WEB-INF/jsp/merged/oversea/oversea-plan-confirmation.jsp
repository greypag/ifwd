            ...
            <div style="width:80%;margin-left:10%">
                ...
                <div class="col-md-7 col-sm-12 col-xs-12 pad-none">
                    ...
                    <div class="oversea-link wht-bg1 text-center" id="toBeCopied" contenteditable="true"><fmt:message key="Overseas.Confirmation.Share.Link" bundle="${msg}" /></div>
                     -->
                    <div class="oversea-link wht-bg1 text-center" id="toBeCopied" contenteditable="true"><%=request.getScheme() + "://" + request.getServerName() +  request.getContextPath()%>/${language}/oversea-insurance?promo=<%=session.getAttribute("myOverseasReferralCode")%></div>
                ...
                <div class="col-md-5 col-sm-12 col-xs-12 pad-none"> 
                    ...
                    <div class="addthis_sharing_toolbox" data-url="<%=request.getScheme() + "://" + request.getServerName() +  request.getContextPath()%>/${language}/oversea-insurance/sharing/?promo=<%=session.getAttribute("myOverseasReferralCode")%>" data-title="iFWD"></div>
                </div>
            </div>
