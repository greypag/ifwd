                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pad-none">
                                <div class="table activation-form vert-middle travel-summary">
                                        ...
                                        <div class="row summary-row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 h4-5 pad-none textUpper">From ${planDetailsForm.departureDate } to ${planDetailsForm.returnDate }</div>
                                        </div>
                                        <div class="row summary-row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 h4-5 pad-none textUpper">${planDetailsForm.countryOfInstitution }</div>
                                        </div>	
                                        <div class="row summary-row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 h4-5 pad-none textUpper">${planDetailsForm.nameOfInstitution }</div>
                                        </div>	
                                        <div class="row summary-row">
