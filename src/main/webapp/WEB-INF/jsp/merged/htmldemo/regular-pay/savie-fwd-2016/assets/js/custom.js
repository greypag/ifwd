...
function addFormBeneficiary (counter) {
	...
	$('<div class="form-group beneficiary-info-row" >'
		...
		+'<input class="form-control gray-textbox capitalize" type="text" autocomplete="off" placeholder="' + fm_placeholder_hkid + '" id="savieBeneficiaryBean['+counter+'].hkId" name="savieBeneficiaryBean['+counter+'].hkId" value="">'
		+'<input class="form-control gray-textbox capitalize hidden" type="text" autocomplete="off" placeholder="' + fm_placeholder_passport + '" id="savieBeneficiaryBean['+counter+'].passportNo" name="savieBeneficiaryBean['+counter+'].passportNo" value="">'
		+'</div>'
		+'</div>'
		...
		+ '<input type="radio" name="savieBeneficiaryBean['+counter+'].gender" value="M" id="male-'+counter+'" checked>'
		...
		+ '<input type="tel" id="savieBeneficiaryBean['+counter+'].entitlement" name="savieBeneficiaryBean['+counter+'].entitlement" class="form-control gray-textbox percentage" placeholder="--" value="">'
