			...
			<div class="fna-product">
				...
				<div class="fna-product-head clearfix">
					...
					<div class="fna-product-cfa hidden-print">
						...
						<a href="<%=request.getContextPath()%>/${language}/savings-insurance/provie-plan-details?isFromRecommand=true" class="fna-btn-sel-product HDR"> <img src="<%=request.getContextPath()%>/resources/images/onlinesavieFNA/iFWD_icon01.png"><fmt:message key="fna.button.applynow" bundle="${msg}" /></a>
						<a href="<%=request.getContextPath()%>/${language}/savings-insurance/provie-plan-details?isFromRecommand=true" class="fna-btn-sel-product HDS"> <img src="<%=request.getContextPath()%>/resources/images/onlinesavieFNA/iFWD_icon01.png"><fmt:message key="fna.button.applynow" bundle="${msg}" /></a>
