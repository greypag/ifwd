			...
			<div class="fna-product">
				...
				<div class="fna-product-head clearfix">
					...
					<div class="fna-product-cfa hidden-print">
						...
						<a href="<%=request.getContextPath()%>/${language}/savings-insurance/provie-plan-details?f=true&planType=RP" class="fna-btn-sel-product HDR"> <img src="<%=request.getContextPath()%>/resources/images/onlinesavieFNA/iFWD_icon01.png"><fmt:message key="fna.button.makeappointment" bundle="${msg}" /></a>
						<a href="<%=request.getContextPath()%>/${language}/savings-insurance/provie-plan-details?f=true&planType=SP" class="fna-btn-sel-product HDS"> <img src="<%=request.getContextPath()%>/resources/images/onlinesavieFNA/iFWD_icon01.png"><fmt:message key="fna.button.makeappointment" bundle="${msg}" /></a>
						...
						<a href="<%=request.getContextPath()%>/${language}/savings-insurance/wealthree" class="fna-btn-sel-product HEW1"> <img src="<%=request.getContextPath()%>/resources/images/onlinesavieFNA/iFWD_icon01.png"><fmt:message key="fna.button.makeappointment" bundle="${msg}" /></a>
						...
						<div class="row">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 visible-xs hidden-print">
								<div class="fna-product-cfa-mobile">
									<a href="<%=request.getContextPath()%>/${language}/savings-insurance/${nextPageFlow}?type=2" class="fna-btn-sel-product KSTS"> <img src="<%=request.getContextPath()%>/resources/images/onlinesavieFNA/iFWD_icon01.png"><fmt:message key="fna.button.applynow" bundle="${msg}" /></a>
									<a href="<%=request.getContextPath()%>/${language}/savings-insurance/provie-plan-details?f=true&planType=RP" class="fna-btn-sel-product HDR"> <img src="<%=request.getContextPath()%>/resources/images/onlinesavieFNA/iFWD_icon01.png"><fmt:message key="fna.button.applynow" bundle="${msg}" /></a>
									<a href="<%=request.getContextPath()%>/${language}/savings-insurance/provie-plan-details?f=true&planType=SP" class="fna-btn-sel-product HDS"> <img src="<%=request.getContextPath()%>/resources/images/onlinesavieFNA/iFWD_icon01.png"><fmt:message key="fna.button.applynow" bundle="${msg}" /></a>
									<a href="<%=request.getContextPath()%>/${language}/savings-insurance/plan-details-rp" class="fna-btn-sel-product KSTR"> <img src="<%=request.getContextPath()%>/resources/images/onlinesavieFNA/iFWD_icon01.png"><fmt:message key="fna.button.makeappointment" bundle="${msg}" /></a>
									<a href="<%=request.getContextPath()%>/${language}/savings-insurance/wealthree" class="fna-btn-sel-product HEW1"> <img src="<%=request.getContextPath()%>/resources/images/onlinesavieFNA/iFWD_icon01.png"><fmt:message key="fna.button.makeappointment" bundle="${msg}" /></a>
									<a href="<%=request.getContextPath()%>/${language}/term-life-insurance" class="fna-btn-sel-product UTLS"> <img src="<%=request.getContextPath()%>/resources/images/onlinesavieFNA/iFWD_icon01.png"><fmt:message key="fna.button.applynow" bundle="${msg}" /></a>
									<a href="<%=request.getContextPath()%>/${language}/medical-insurance" class="fna-btn-sel-product HEH"> <img src="<%=request.getContextPath()%>/resources/images/onlinesavieFNA/iFWD_icon01.png"><fmt:message key="fna.button.applynow" bundle="${msg}" /></a>
