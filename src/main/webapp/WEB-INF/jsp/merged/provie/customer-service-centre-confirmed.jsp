         ...
         <div class="row" id="appointment-form-holder">
               ...
               <div class="col-xs-12 col-md-6" id="left-side-form">
		           ...
		           <div class="">
		            ...
		            </div><div class="after-login">
						<div class="form-group">
                            <div class="fld-wrapper">
                                <p class="fld-label">Username</p>
		           ...
		           <div class="after-login">
						<div class="form-group">
                            <div class="fld-wrapper">
                                <p class="fld-label">Confirm login as</p>
                                <p class="fld-val">Mr. Pang siu ming</p>
                            </div>
                        </div>
		           </div>
							...
							<div class="panel-group" id="accordion">
								<div class="panel">
									<div class="panel-heading">
										<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#pan-login">Login to confirm appointment<img src="<%=request.getContextPath()%>/resources/images/orange-caret.png" class="orange-caret-bg"></a></h4>
									</div>
