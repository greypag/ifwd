            ...
            <div class="fwd-container container-fluid breadcrumbs savie-regular-pay-breadcrumbs">
                <div class="breadcrumb-container">
                    <ol class="breadcrumb breadcrumbs-product-details et-breadcrumbs">
                        ...
                        <li><a href="#"><fmt:message key="breadcrumb.item.save" bundle="${msg}" /></a></li>
                        <li class="divider"><i class="fa fa-angle-right"></i> </li>
                        <li class="active-bc" id="et-active-bc-menu"><fmt:message key="breadcrumb.item.provie" bundle="${msg}" /></li>
                    </ol>
                </div>
            </div>
        </div>
...
//Check is more than 2 tries from backend
		...
		$('#preferred-date-QB').datepicker({
			...
			if(!!$("#centre").val() && $("#centre").val().trim() != "" && $("#preferred-date-QB").val().trim() != ""){
				getTimeSlot('', '1');
			}
			else{
		...
		if(!!$("#centre").val() && $("#centre").val().trim() != "" && $("#preferred-date-" + serviceCentreCode).val() != ""){
			getTimeSlot('', '1');
		}
				...
				        url:'${pageContext.request.contextPath}/ajax/savings-insurance/getAppointmentAccessCode',
				        ...
				        success:function(data){
							if(data.errMsgs != null && data.errMsgs != ''){
								...
								var url = '${pageContext.request.contextPath}/${language}/savings-insurance/provie/${nextPageFlow}';
