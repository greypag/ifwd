...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        success: function(data) {
            thirdPrice = data.grossPremium;
        	$('#third-price big').html(thirdPrice);
        }
    });
    ...
    $.ajax({
        ...
        success: function(data) {
            goldPrice = data.grossPremium;
        }
    });

    $('#silver-diff').html(silverPrice-thirdPrice);
    $('#gold-diff').html(goldPrice-thirdPrice);
                        ...
                        <form action="" method="post">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-3 text-right">
                                    ...
                                    <div id="third-price" class="price">
                                        <small>from</small>
                                        <big></big>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-10 col-xs-offset-1 col-sm-4 col-sm-offset-4 text-center">
                                    <br />
                                    <a href="#" class="bdr-curve btn btn-primary nxt-btn third-next">Get Third Party</a>
                                    <br />
                                    <br />
                                </div>
                            </div>
                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="row">
                            <div class="col-xs-6">
                                <br />
                                <br />
                                <a href="#" class="bdr-curve btn btn-primary nxt-btn">Back</a>
                                <br />
                                <br />
                                <br />
                                <br />
...
<section id="" class="motor-select-plan2">
    <div class="container">
        <div class="center wow fadeInDown animated" > 
            <!--desktop-->
            <h1 class=" col-md-10 col-md-offset-1 hidden-sm hidden-xs ">Get Your quote in a minute</h1>
            <!--end-desktop--> 
            <!--Mobile-->
            <h1 class="hidden-lg hidden-md motor-ttl">Get Your quote in a minute</h1>
            <!--end mobile--> 
        </div>
        <div class="row planbox-wrapper dark-green-color">
            <div class="col-md-6 plan-panel">
                <div class="blue-color">
                    <div class="row">
                        ...
                        <div class="col-xs-10 col-sm-9">
                            <h3>Lorem ipsum dolor sit amet</h3>
                            <h1>+ $<span id=silver-diff></span></h1>
                            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
                        </div>
                    </div>
                </div>
