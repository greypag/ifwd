...
<head>
  ...
  <!-- Title -->
  <title>MonCare - Screen Insurance| FWD Hong Kong</title>
...
<!--   <link rel="resources/css/bootstrapValidator.min.css">
 -->  <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/passkit/bootstrapValidator.min.css">
...
<body>
  ...
  <div class="container main landing">
    <div class="hero" style="background-image: url('resources/images/header-image.jpg');">
      <div class="shadow"></div>
      <div class="text-wrap">
        <h1>意外爆mon、裂mon，我哋都保</h1>
        <p>送您高達800港元保額的富衛X Sony Xperia™ 爆 Mon 手機屏幕保險</p>
      </div>
    </div>
    <div>
      <!-- body start -->
