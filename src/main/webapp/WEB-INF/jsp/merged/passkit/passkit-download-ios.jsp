		...
		<div>
			...
			<div class="col-xs-12 center download-page">
				...
				<div class="add-to-wallet">
					<a class="button-link" href="#"><img src="include/images/tc/btn-applewallet.png" alt="Add to Apple Wallet" /></a>
					<p>如欲添加此流動版本的保險證明書到您的手機，請按「Add to Apple Wallet」鍵，證明書便可直接添加到您的Apple Wallet。</p>
				</div>
			</div>
			<!-- body end -->
		</div>
