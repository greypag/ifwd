...
<head>
	...
	<link rel="stylesheet" type="text/css" href="include/css/download.css" />
		...
		<div>
			...
			<div class="col-xs-12 center download-page">
				...
				<div class="add-to-wallet">
					<a class="button-link" href="#"><img src="include/images/tc/btn-pass2u.png" alt="Add to Pass2U" /></a>
					<a class="button-link" href="#"><img src="include/images/tc/btn-googleplay.png" alt="Get it on Google Play " /></a>
					<p>如欲添加此流動版本的保險證明書到您的手機，請按「Add to Pass2U」鍵，證明書便可直接添加到您的流動錢包程式。如果您未有相關程式，請到Google Play商店下載。</p>
				</div>
			</div>
			<!-- body end -->
		</div>
