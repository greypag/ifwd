...
<div class="sign-up-teaser">
	...
	<form class="sign-up-teaser-form" method="post" id="teaserSignUpForm" action="teaser.jsp">
		<div class="form-group">
			...
			<input type="number" placeholder="<fmt:message key="savie.interestGather.signupform.enter.phone" bundle="${msg}" />" class="form-control email phone-no" id="teaserPhoneNo" name="teaserPhoneNo" maxlength="8" min="1" oninput="maxLengthReview(this)" onkeydown="return isNumberKey(event)">
