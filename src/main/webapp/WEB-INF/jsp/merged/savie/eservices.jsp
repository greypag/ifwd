											...
											<div class="category-holder">
												...
												<div class="row category-info-row row-gray">
													...
													<div class="col-xs-6 col-md-3 mbview-category-info">
														...
														<p class="info-data"><fmt:message key="label.status.not.complete" bundle="${msg}" /></p>
													</div>
												...
												<div class="row category-info-row">
													...
													<div class="col-xs-6 col-md-3 visible-md visible-lg mbview-category-info">
														<h4 class="visible-xs visible-sm info-head"><fmt:message key="label.status" bundle="${msg}" /></h4>
														<p class="info-data"><fmt:message key="label.status.complete" bundle="${msg}" /></p>
													</div>											
													<div class="col-xs-6 col-md-2 mbview-category-info">
														<h4 class="visible-xs visible-sm info-head"><fmt:message key="label.insured.amount" bundle="${msg}" /></h4>
														<p class="info-data">800,000.00</p>
										...
										<div class="travel-container">
											<div class="category-holder">
												...
												<div class="row category-info-row row-gray">
													...
													<div class="col-xs-6 col-md-2 mbview-category-info">
														<h4 class="visible-xs visible-sm info-head"><fmt:message key="label.resources" bundle="${msg}" /></i></h4>
										...
										<div class="saving-insurance-container">
											<div class="category-holder">
												...
												<div class="row category-info-row row-gray">
													...
													<div class="col-xs-6 col-md-3 visible-md visible-lg mbview-category-info">
														<h4 class="visible-xs visible-sm info-head"><fmt:message key="label.status" bundle="${msg}" /></h4>
														<p class="info-data"><a href="#" data-toggle="modal" data-target="#retrieve-application-modal"><fmt:message key="label.status.resume.application" bundle="${msg}" /></a></p>
													</div>											
													<div class="col-xs-6 col-md-2 mbview-category-info">
														<h4 class="visible-xs visible-sm info-head"><fmt:message key="label.account.value" bundle="${msg}" /> (HK$)</h4>
										...
										<div class="life-and-health-container">
											<div class="category-holder">
												...
												<div class="row category-info-row row-gray">
													...
													<div class="col-xs-6 col-md-3 mbview-category-info">
														<h4 class="visible-xs visible-sm info-head"><fmt:message key="label.start.date" bundle="${msg}" /></i></h4>
														<p class="info-data"><fmt:message key="label.status.not.complete" bundle="${msg}" /></p>
													</div>
													<div class="col-xs-6 col-md-3 visible-md visible-lg mbview-category-info">
														<h4 class="visible-xs visible-sm info-head"><fmt:message key="label.status" bundle="${msg}" /></h4>
