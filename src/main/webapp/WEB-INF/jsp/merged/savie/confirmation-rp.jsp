...
<div class="fwd-savie-wrapper fwd-evergreen-wrapper">
    ...
    <script src="<%=request.getContextPath()%>/resources/js/vendor/html2canvas.js"></script>
    <script src="<%=request.getContextPath()%>/resources/js/vendor/jquery.plugin.html2canvas.js"></script>
