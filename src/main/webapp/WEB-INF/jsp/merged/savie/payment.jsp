							...
							<div class="col-xs-12 col-md-6">
								...
								<c:if test="${saviePlanDetails.insuredAmountDiscount!=null && saviePlanDetails.insuredAmountDiscount!='0'}">
									<div class="info-wrapper">
										...
										<p class="info-value">
											HK$ ${saviePlanDetails.insuredAmountDiscount} <!--fmt:formatNumber value="${saviePlanDetails.insuredAmountDiscount}"/-->
									...
									<div class="info-wrapper">
										...
										<p class="info-value">
											HK$ ${saviePlanDetails.insuredAmountDue} <!--fmt:formatNumber value="${saviePlanDetails.insuredAmountDue}"/-->
