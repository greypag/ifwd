        		...
        		<div class="usp row">
        			...
        			<div class="usp-item clearfix col-xs-12 col-md-4">
        				...
        				<div class="item-desc">
        					...
        					<p class="padded"><fmt:message key="savie.online.usp.savie2.copy" bundle="${msg}" /></p>
        				</div>
        			</div>
        			<div class="usp-item clearfix col-xs-12 col-md-4">
						...
						<div class="blogs-holder clearfix fwd-container-limit">
							<div class="blogs first">
								...
								<div class="orange-overlay text-center">
									...
									<p class="definition"><fmt:message key="savie.online.landing.blog.definition3" bundle="${msg}" /></p>
