								...
								<div class="navbar-collapse padding-reset" id="bs-navbar-menu">
									<ul class="navigation">
										...
										<li class="dropdown full-width">
											...
											<div class="dropdown-menu others-drop" role="menu" aria-labelledby="dropdownMenu">
												<div class="fwd-container container-fluid savie-dropdown">
													<div class="row whole-tab">
														<div class="savie-col savie-items">
															<div class="row">
										...
										<li class="dropdown full-width">
											...
											<div class="dropdown-menu others-drop max-width" role="menu" aria-labelledby="dropdownMenu">
												<div class="fwd-container container-fluid savie-dropdown">
													<div class="row whole-tab">
														<div class="savie-col savie-items">
															<div class="row">
