             ...
             <form action="" id="paymentForm" method="post">
               <div class="col-xs-12 col-md-6" id="left-side-form">
                   <h5><fmt:message key="label.service.centre.title" bundle="${msg}" /></h5>
					...
					<div class="form-group customer-formgroup">
						<div class="payment-select-wrapper">
							<p class="customer-select-label"><fmt:message key="Placeholder.centre" bundle="${msg}" /></p>
				   ...
				   <div class="form-group customer-formgroup">
					...
					<div class="form-group customer-formgroup">
						<div class="payment-select-wrapper">
							<p class="customer-select-label"><fmt:message key="Placeholder.time" bundle="${msg}" /></p>
