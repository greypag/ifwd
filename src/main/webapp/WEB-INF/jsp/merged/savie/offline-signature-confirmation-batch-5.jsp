	               ...
	               <div class="browse-container">
	                  <div class="row reset-margin hidden-xs hidden-sm">
	                     <ul class="common-steps-list five-steps nav nav-pills">
							...
							<li class="arrow-next-step"> <img src="assets/images/savie-2016/header-browse-arrow.png" class="browse-arrow" /></li>
							<li class="step-number"><button type="button" class="et-header-info-btn completed-step"><i class="fa fa-check"></i>Payment</button></li>
							<li class="arrow-next-step"> <img src="assets/images/savie-2016/header-browse-arrow.png" class="browse-arrow" /></li>
							<li class="step-number"><button type="button" class="et-header-info-btn completed-step"><i class="fa fa-check"></i>Upload document</button></li>
							<li class="arrow-next-step"> <img src="assets/images/savie-2016/header-browse-arrow.png" class="browse-arrow" /></li>
							<li class="step-number"><button type="button" class="et-header-info-btn active"><span class="status">5</span>Confirmation</button></li>
						 </ul>
	                 </div>
	               </div>  
						...
						<div class="requirements-panel">
							...
							<div class="row requirements-list">
								...
								<div class="col-xs-12 col-md-6">
									...
									<div class="requirement-text-wrapper"><p>Please bring along a copy of your HKID, pass-port, proof of address and policy number <span class="orange-note">or settle the premium with Bank of Communication FWD Credit Card</span></p></div>
								</div>
							</div>
