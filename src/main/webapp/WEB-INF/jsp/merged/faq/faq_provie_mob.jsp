...
<!-- Easy Health start -->
<div id="faq_provie_mob" class="col-xs-12 col-sm-12 pad-none faq_care_container" style="display:none;">
    <div class="col-xs-12 col-sm-12 hidden-md hidden-lg pad-none faq_title_container">
        <div class="faq_back" onclick="faqMainMenuMob('provie')">
            <i class="fa fa-arrow-left fa-2"></i>
        </div>
        <div class="faq_title">
           <fmt:message key="faq.provie" bundle="${msg}" />
        </div>
