                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 pad-none">
                            ...
                            <div class="partner_tnc">
                                <div class="partner_tnc_list">
                                    <ul class="bullets">
                                        <li>
                                           <p class="h4-5"><fmt:message key="the.club.copy8.1" bundle="${msg}" /> <a href="<fmt:message key="theclub.link" bundle="${msg}" />" target="_blank"><fmt:message key="partner.the.club.tnc1.part2" bundle="${msg}" /></a> <fmt:message key="partner.the.club.tnc1.part3" bundle="${msg}" /></p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <ul class="bullets">
                                        <li>
                                        	<p class="h4-5">
                                            	...
                                            	<fmt:message key="y5buddy.copy1.2.linktext1" bundle="${msg}" /> <a href="<fmt:message key="y5buddy.copy1.2.1.url" bundle="${msg}" />" target="_blank"><u><fmt:message key="y5buddy.copy1.2.linktext2" bundle="${msg}" /></u></a> <fmt:message key="y5buddy.copy1.2.linktext3" bundle="${msg}" />
											</p>
                                        </li>                                       
                                        <!--<li>
