                                    ...
                                    <div class="col-md-12">
                                                        ...
                                                        <div class="fwdpanel-body" >
                                                            <table id="summary" class="table table-bordred">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td><fmt:message key="workingholiday.quote.fullDetails.table.row4.col2.desc2.subheading" bundle="${msg}" /><br/>
                                                                            <fmt:message key="workingholiday.quote.fullDetails.table.row4.col2.desc2.content" bundle="${msg}" />
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td><fmt:message key="workingholiday.quote.fullDetails.table.row4.col2.desc3.subheading" bundle="${msg}" /><br/> 
                                                                            <fmt:message key="workingholiday.quote.fullDetails.table.row4.col2.desc3.content" bundle="${msg}" />
                                                                        </td>
                                        ...
                                        <div class="fwdpanel fwdpanel-primary">
                                            <div class="fwdpanel-heading">
                                                <h4 class="fwdpanel-title h4-4-full">
                                                    <span><i
                                                            class="fa fa-plus"></i>  <a href="#" data-target="#details-popup-4" data-toggle="modal"><fmt:message key="workingholiday.quote.fullDetails.ageLimit" bundle="${msg}" /></a> </span>
                                                </h4>
                                            </div>
                                            <div class="modal fade details-popup" id="details-popup-4" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content plan-modal">
                                                        ...
                                                        <div class="fwdpanel-body">
                                                            <div class="fwdpanel-heading">
                                                                <h4 class="fwdpanel-title h4-4-full "><fmt:message key="workingholiday.quote.fullDetails.ageLimit" bundle="${msg}" /></h4>
                                                            </div>
