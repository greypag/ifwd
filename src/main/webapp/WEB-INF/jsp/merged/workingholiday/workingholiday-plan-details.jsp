			...
			<form:form name="frmYourDetails" id="frmYourDetails" method="post"
				...
				<ol class="breadcrumb pad-none">
					<li><a href="#"><fmt:message
								key="workingholiday.breadcrumb1.item1" bundle="${msg}" /></a> <i
						class="fa fa-caret-right"></i></li>
					<li><a href="#"><fmt:message
								key="workingholiday.breadcrumb1.item2" bundle="${msg}" /></a> <i
						class="fa fa-caret-right"></i></li>
					<li><a href="#"><fmt:message
							...
							<div class="form-group float">
								...
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									<input type="text" name="whAppHKID"
										...
										id="inputWhAppHKID"
										placeholder="<fmt:message key="workingholiday.details.applicant.hkid.placeholder" bundle="${msg}" />"
								...
								<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none">
									...
									<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 pad-none">
										<input id="inputWhInsHKID" name="whInsHKID"
											...
											placeholder="<fmt:message key="workingholiday.details.insured.beneficiary.hkid.placeholder" bundle="${msg}" />"
							...
							<div class="form-wrap">
								<div class="membership-header">
									<h3 class="bmg-membership-header">
										<fmt:message key="workingholiday.details.registration.heading"
											bundle="${msg}" />
									</h3>
									<i class="text-grey"><fmt:message
											key="workingholiday.details.registration.desc"
											bundle="${msg}" /></i>
									<h3 class="error-hide"
								...
								<div class="form-group float row">
									<div class="form-label col-lg-5 col-md-5 col-sm-12 col-xs-12">
										<label class="field-label bold-500"><fmt:message
												key="workingholiday.details.registration.username"
												bundle="${msg}" /></label>
									</div>
								...
								<div class="form-group float row">
									<div class="form-label col-lg-5 col-md-5 col-sm-12 col-xs-12">
										<label class="field-label bold-500"><fmt:message
												key="workingholiday.details.registration.password"
												bundle="${msg}" /></label>
									</div>
									<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
										<input type="password"
								...
								<div class="form-group float row">
									<div class="form-label col-lg-5 col-md-5 col-sm-12 col-xs-12">
										<label class="field-label bold-500"><fmt:message
												key="workingholiday.details.registration.confirmPassword"
												bundle="${msg}" /></label>
									</div>
									<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
										<input type="password"
											...
											placeholder="<fmt:message key="workingholiday.details.registration.confirmPassword.placeholder" bundle="${msg}" />">
