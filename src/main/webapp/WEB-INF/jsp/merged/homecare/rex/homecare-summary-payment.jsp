		...
		<div class="row">
			<form name="paymentForm" id="paymentForm"
				...
				<ol class="breadcrumb pad-none">
					...
					<li><a href="#">##home.breadcrumb1.item3@@ </a><i class="fa fa-caret-right"></i>
					</li>
					<li><a href="#">##home.breadcrumb1.item4@@ </a></li>
					<li class="active "><i class="fa fa-caret-right"></i> ##home.breadcrumb1.item5@@ </li>
				</ol>
				<div class="container ">
					<div
						class="col-lg-12 col-md-12 col-sm-12 col-xs-12 shop-tracking-status">
						<div class="center" style="visibility: visible;">
							<h2>##home.summary.jumbo@@</h2>
						</div>
						<br> <br>
							...
							<div id="tr-wizard" class="shop-tracking-status">
								<div class="order-status">
									...
									<div
										...
										<span class="status color2"> ##home.breadcrumb2.item3@@ </span>
				...
				<div class="container pad-none bdr ur-opt-content gray-bg3">
					<div
						...
						<div class="col-lg-6 col-xs-12 col-sm-12 col-md-6 pad-none">
							<h3 class="margin-left-2 h2-3-existing-fwd-head">##home.summary.plansummary.heading@@</h3>
							<table class="table activation-form margin-left-2">
								<tbody>
									<tr>
										<td class="h2-1 pad-left1 col-lg-5">##home.summary.plansummary.desc1@@</td>
										<td class=" h4-5">${createdPolicy.getReferenceNo() }<input
											type="hidden" name="referenceNo"
											value="${createdPolicy.getReferenceNo()}"></td>
									</tr>
									<tr>
										<td class="h2-1 ">##home.summary.plansummary.desc2@@</td>
										<td class="h4-5 ">##home.summary.plansummary.desc3@@<br> ##home.summary.plansummary.desc4@@ <br>
											<h4 class="h4-4-full"><!-- + Full coverage details --></h4></td>
									</tr>
									<tr>
										<td class="h2-1 ">##home.summary.plansummary.desc5.part1@@ <br>##home.summary.plansummary.desc5.part2@@
										</td>
									...
									<tr>
										<td class="h2-1 ">##home.summary.plansummary.desc6@@</td>
									...
									<tr>
										<td class="h2-1 ">##home.summary.plansummary.desc7.part1@@<br>##home.summary.plansummary.desc7.part2@@
										</td>
										<td class=" h4-5 ">${homeCareDetails.getNetFloorArea()}</td>
									</tr>
									<tr>
										<td class="h2-1 ">##home.summary.plansummary.desc8@@</td>
										<td class=" h4-5 ">Yearly</td>
									</tr>
									<tr>
										<td class="h2-1 ">##home.summary.plansummary.desc9.part1@@<br>##home.summary.plansummary.desc9.part2@@
										</td>
										<td class=" h4-5 ">From ${effectiveDate } to
											${effectiveEndDate}</td>
									</tr>
									<tr>
										<td class="pad-none"><span class="h4-4-orange-b pad-none">##home.summary.plansummary.desc10@@</span></td>
						...
						<div
							...
							<h4 class="h4-trav-full col-xs-offset-8">
								<a href="#" onclick="BackMe()">##home.summary.changedetail.heading@@</a>
							</h4>
							<table class="table activation-form margin-left-2">
								<tbody>
									<tr>
										<td class="pad-none h2-3-existing-fwd-head ">##home.summary.changedetail.desc1@@</td>
										<td class="pad-none h4-5 "></td>
									</tr>
									<tr>
										<td class="h2-1 pad-none ">##home.summary.changedetail.desc2@@</td>
										<td class="pad-none h4-5 ">${userDetails.getFullName()}</td>
									</tr>
									<tr>
										<td class="h2-1 pad-none ">##home.summary.changedetail.desc3@@</td>
										<td class="pad-none h4-5 ">${userDetails.getHkid() }</td>
									</tr>
									<tr>
										<td class="h2-1 pad-none ">#home.summary.changedetail.desc4@@</td>
				...
				<div class="gray-bg1">
					<div class="clearfix"></div>
					<h2 class="from-control">##home.summary.pmtdetail.heading@@</h2>
					<h3><span id="paymentGatewayErrorMsg"  class="text-red">${errormsg}</span></h3>
					<table class="table-responsive travel-tb">
						<tbody>

							<tr class="control-group">
								<td class="col-lg-4 ht1"><label class="control-label h4-5">##home.summary.pmtdetail.desc1@@</label></td>
							...
							<tr class="control-group">
								<td class="col-lg-4 ht1"><label class="control-label h4-5">##home.summary.pmtdetail.desc2@@</label></td>
							...
							<tr class="control-group">
								<td class="col-lg-4 ht1"><label class="control-label  h4-5">##home.summary.pmtdetail.desc3@@</label></td>
...
<!-- 										<option VALUE="2020">2020</option> -->
							...
							<tr class="control-group">
								<td class="col-lg-4 ht1"><label class="control-label  h4-5">##home.summary.pmtdetail.desc4@@</label></td>
								<td colspan="2">
									<div class="controls">
							...
							<tr class="control-group">
								<td class="col-lg-4 ht1"><label class="control-label  h4-5">##home.summary.pmtdetail.desc5@@</label></td>
							...
							<tr class="control-group">
								<td></td>
								<td colspan="2"><!--<a class="sub-link" href="#">##home.summary.pmtdetail.desc6@@</a>--></td>
							</tr>
					...
					<div class="declaration-content margin-left-small">
						<div class="checkbox">
							<input id="checkbox3" type="checkbox"> <label
								for="checkbox3"> ##home.summary.declarations@@ </label>
							<div class="clearfix"></div>
						</div>
