		...
		<div class="container">
			<div class="row">
				...
				<ol class="breadcrumb pad-none">
					...
					<li><a href="#">##home.breadcrumb1.item2@@</a></li>
					<li class="active "><i class="fa fa-caret-right"></i>##home.breadcrumb1.item1@@</li>
				</ol>
				<div class="container ">
					<div class="col-lg-12 col-md-12 shop-tracking-status">
						<div class="center" style="visibility: visible;">
							<h2>##home.quote.jumbo@@</h2>
						</div>
						<br> <br>
							...
							<div id="tr-wizard" class="shop-tracking-status">
								<div class="order-status">
									...
									<div
										...
										<span class="status">##home.breadcrumb2.item1@@</span>
										<div class="icon">1</div>
									</div>

									<div
										class="image-order-status image-order-status-intransit  img-circle disabled">
										<span class="status">##home.breadcrumb2.item2@@</span>
									...
									<div class="col-md-12">
										...
										<div class="fwdpanel fwdpanel-primary">
											<div class="fwdpanel-heading">
												<h4 class="fwdpanel-title h4-4-travel margin-left">
													<span><a href="#" class="fwdpanel-minimize"><i
															class="fa fa-plus"></i> ##home.quote.highlight.heading@@ </a> </span>
												</h4>
											</div>
											<div class="fwdpanel-body" style="display: none;">
												<p>##home.quote.highlight.desc1@@</p>
												<p>##home.quote.highlight.desc2@@</p>
												<p>##home.quote.highlight.desc3@@</p>
												<br>
												<p>##home.quote.highlight.desc4@@</p>
											</div>
										</div>
										<!-- /  Product Highlights -->
										...
										<div class="fwdpanel fwdpanel-primary">
											<div class="fwdpanel-heading">
												<h4 class="fwdpanel-title h4-4-travel margin-left">
													<span><a href="#" class="fwdpanel-minimize"><i
															class="fa fa-plus"></i>##home.quote.summary.heading@@ </a> </span>
												</h4>
											</div>
											<div class="fwdpanel-body" style="display: none;">

												<h4 class="h4-2">
													<strong> ##home.quote.summary.subheading1@@ </strong>
												</h4>
												<p>##home.quote.summary.subheading1.desc1@@</p>
												<br>
												<p>##home.quote.summary.subheading1.desc2@@</p>
												<br>
												...
												<h4 class="h4-2">
													<strong>##home.quote.summary.subheading2@@</strong>
												</h4>
												<p>##home.quote.summary.subheading2.desc1@@</p>
												<p>##home.quote.summary.subheading2.desc2@@</p>
												<p>##home.quote.summary.subheading2.desc3@@</p>
												<p>##home.quote.summary.subheading2.desc4@@</p>

												<p>##home.quote.summary.subheading2.desc5@@</p>
										...
										<div class="fwdpanel fwdpanel-primary">
											<div class="fwdpanel-heading">
												<h4 class="fwdpanel-title h4-4-travel margin-left">
													<span><a href="#" class="fwdpanel-minimize"><i
															class="fa fa-plus"></i> ##home.quote.exclusion.heading@@ </a> </span>
												</h4>
											</div>
											<div class="fwdpanel-body" style="display: none;">
												<p>
													##home.quote.exclusion.desc1@@  <br>
												<ul>
													<li>##home.quote.exclusion.desc2@@</li>
													<li>##home.quote.exclusion.desc3@@</li>
													<li>##home.quote.exclusion.desc4@@</li>
													<li>##home.quote.exclusion.desc5@@</li>
													<li>##home.quote.exclusion.desc6@@</li>
										...
										<div class="fwdpanel fwdpanel-primary">
											...
											<div class="fwdpanel-body" style="display: none;">
												...
												<table id="Premium" class="table table-bordred">
													<tbody>
														<tr>
															<td colspan="1" rowspan="2"><strong></strong> Section 1 - Household Content </td>
					...
					<div
						...
						<form:form name="frmHomeCarePlan" id="frmHomeCarePlan"
							...
							<div class="form-container">
								...
								<h3>##home.details.summary.desc4@@</h3>
								...
								<div class="form-group">
									<div class="input-group">
										<input type="text" id="referralCode" name="referralCode"
											...
											class="apply pointer" onclick="applyPromoCode()">##home.action.apply@@</span>
								...
								<div class="travel-italic">
									<a href="" class="sub-link" data-toggle="modal"
										data-target=".bs-promo-modal-lg"><i>##home.details.summary.promocode.help@@</i></a>
								</div>
							</div>
							...
							<h3 class="h4-1-orange-b col-lg-6 col-md-6 marg-t">##home.details.summary.discount@@
							</h3>
							<h3 id="discountAmt"
            ...
            <div class="col-lg-6 col-md-6 text-right"> <a href="homecare-plan-details.html" class="bdr-curve btn btn-primary nxt-btn ">Next</a> </div>-->
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pull-right">
								<button type="submit" class="bdr-curve btn btn-primary nxt-btn">##home.action.next@@</button>
							</div>
				...
				<p class="padding1 hidden-sm hidden-xs">
					##home.quote.other.disclaimer.part1@@ <a
						class="sub-link"
						href="policy-provisions-pdf/Easy_HomeCare_Provisions_Mar_2015.pdf"
						target="_blank">##home.quote.other.disclaimer.part2@@</a> ##home.quote.other.disclaimer.part3@@ <br> ##home.quote.other.disclaimer.part4@@
				</p>
	...
	<form:form name="frmHomeCarePlan" id="frmHomeCarePlan"
		...
		<div class="row hidden-lg hidden-md text-center">
			...
			<div class="col-sm-12 col-xs-12 gray-bg">
				<h3 class="col-sm-6 col-xs-6">##home.details.summary.desc4@@</h3>
		...
		<div class="row-fluid hidden-lg hidden-md text-center">
			<div class="">
				<button type="submit"
					...
					<h3 class="text-center marg-t">##home.action.next@@</h3>
				</button>
			</div>
				<!-- 
