       	...
       	<div class="payment-mode">
        	...
        	<div class="desktop-inline rate-holder">
        		<div class="rate">
        			...
        			<ul class="clearfix">
        				<li><span class="percent">3%</span> [<fmt:message key="saints.landing.1st" bundle="${msg}" />]</li>
        				<li class="with-padding"><span class="percent">3%</span> [<fmt:message key="saints.landing.2nd" bundle="${msg}" />]</li>
        				<li class="with-padding"><span class="percent">3.3%</span> [<fmt:message key="saints.landing.3rd" bundle="${msg}" />]</li>
        			</ul>
        		</div>
       		</div>
		        			...
		        			<div class="row">
		        				...
		        				<div class="col-xs-6 text-center annualTravel_policy_item">
									...
									<div class="hidden-benefits benefits-content">
										<img src="<%=request.getContextPath()%>/resources/images/savie-regular/benefit-2.png" />
										<div class="info hidden-benefits-info">
											<h3 class="hidden-benefits-info"><fmt:message key="saints.landing.issue.age" bundle="${msg}" /></h3>
											<p class="hidden-benefits-info"><fmt:message key="saints.landing.issue.age.content1" bundle="${msg}" /> <span><fmt:message key="saints.landing.issue.age.content2" bundle="${msg}" /></span></p>
										</div>
									</div>
		        				</div>
		        			</div>
		        			<div class="row">
		        				<div class="col-xs-6 text-center annualTravel_policy_item">
									...
									<div class="hidden-benefits benefits-content">
										<img src="<%=request.getContextPath()%>/resources/images/savie-regular/benefit-3.png" />
										<div class="info hidden-benefits-info">
											<h3 class="hidden-benefits-info"><fmt:message key="saints.landing.charges" bundle="${msg}" /></h3>
											<p class="hidden-benefits-info"><fmt:message key="saints.landing.charges.content1" bundle="${msg}" /> <span><fmt:message key="saints.landing.charges.content2" bundle="${msg}" /></span></p>
										</div>
									</div>
		        				</div>
		        				<div class="col-xs-6 text-center annualTravel_policy_item">
									...
									<div class="hidden-benefits benefits-content">
										<img src="<%=request.getContextPath()%>/resources/images/savie-regular/benefit-4.png" />
										<div class="info hidden-benefits-info">
											<h3 class="hidden-benefits-info"><fmt:message key="saints.landing.earning" bundle="${msg}" /></h3>
											<p class="hidden-benefits-info"><fmt:message key="saints.landing.earning.content1" bundle="${msg}" /> <span><fmt:message key="saints.landing.earning.content2" bundle="${msg}" /></span></p>
										</div>
									</div>
		        				</div>
		        			</div>
		        			<div class="row">
		        				<div class="col-xs-6 text-center annualTravel_policy_item">
									...
									<div class="hidden-benefits benefits-content">
										<img src="<%=request.getContextPath()%>/resources/images/savie-regular/benefit-5.png" />
										<div class="info hidden-benefits-info">
											<h3 class="hidden-benefits-info"><fmt:message key="saints.landing.hotline" bundle="${msg}" /></h3>
											<p class="hidden-benefits-info"><fmt:message key="saints.landing.hotline.content1" bundle="${msg}" /> <span><fmt:message key="saints.landing.hotline.content2" bundle="${msg}" /></span></p>
										</div>
									</div>
		        				</div>
		        				<div class="col-xs-6 text-center annualTravel_policy_item">
		        					<img src="<%=request.getContextPath()%>/resources/images/savie-regular/benefit-6.png">
		        					<span class="two-lines"><fmt:message key="saints.landing.payment" bundle="${msg}" /></span>
									<div class="hidden-benefits benefits-content">
										<img src="<%=request.getContextPath()%>/resources/images/savie-regular/benefit-6.png" />
										<div class="info">
											<h3 class="hidden-benefits-info"><fmt:message key="saints.landing.payment" bundle="${msg}" /></h3>
											<p class="hidden-benefits-info"><fmt:message key="saints.landing.payment.content1" bundle="${msg}" /> <span><fmt:message key="saints.landing.payment.content2" bundle="${msg}" /></span></p>
										</div>
									</div>
		        				</div>
		        			</div>
									...
									<div class="tab-content carousel-inner clearfix" role="listbox">
										...
										<div role="tabpanel" class="fna-tab-content tab-pane item" id="benefits-navtabs-2">
											<div class="benefits-content clearfix">
												<img src="<%=request.getContextPath()%>/resources/images/savie-regular/benefit-2.png">
												<div class="info">
													<h3><fmt:message key="saints.landing.issue.age" bundle="${msg}" /></h3>
											        <p><fmt:message key="saints.landing.issue.age.content1" bundle="${msg}" /> <span><fmt:message key="saints.landing.issue.age.content2" bundle="${msg}" /></span></p>
												</div>
											</div>
										</div>
										<div role="tabpanel" class="fna-tab-content tab-pane item" id="benefits-navtabs-3">
											<div class="benefits-content clearfix">
												<img src="<%=request.getContextPath()%>/resources/images/savie-regular/benefit-3.png">
												<div class="info">
													<h3><fmt:message key="saints.landing.charges" bundle="${msg}" /></h3>
											        <p><fmt:message key="saints.landing.charges.content1" bundle="${msg}" /> <span><fmt:message key="saints.landing.charges.content2" bundle="${msg}" /></span></p>
												</div>
											</div>
										</div>
										<div role="tabpanel" class="fna-tab-content tab-pane item" id="benefits-navtabs-4">
											<div class="benefits-content clearfix">
												<img src="<%=request.getContextPath()%>/resources/images/savie-regular/benefit-4.png">
												<div class="info">
													<h3><fmt:message key="saints.landing.earning" bundle="${msg}" /></h3>
											        <p><fmt:message key="saints.landing.earning.content1" bundle="${msg}" /> <span><fmt:message key="saints.landing.earning.content2" bundle="${msg}" /></span></p>
												</div>
											</div>
										</div>
										<div role="tabpanel" class="fna-tab-content tab-pane item" id="benefits-navtabs-5">
											<div class="benefits-content clearfix">
												<img src="<%=request.getContextPath()%>/resources/images/savie-regular/benefit-5.png">
												<div class="info">
													<h3><fmt:message key="saints.landing.hotline" bundle="${msg}" /></h3>
											        <p><fmt:message key="saints.landing.hotline.content1" bundle="${msg}" /> <span><fmt:message key="saints.landing.hotline.content2" bundle="${msg}" /></span></p>
												</div>
											</div>
										</div>
										<div role="tabpanel" class="fna-tab-content tab-pane item" id="benefits-navtabs-6">
											<div class="benefits-content clearfix">
												<img src="<%=request.getContextPath()%>/resources/images/savie-regular/benefit-6.png">
												<div class="info">
													<h3><fmt:message key="saints.landing.payment" bundle="${msg}" /></h3>
											        <p><fmt:message key="saints.landing.payment.content1" bundle="${msg}" /> <span><fmt:message key="saints.landing.payment.content2" bundle="${msg}" /></span></p>
												</div>
											</div>
										</div>
									</div>
       			...
       			<div class="row partners-holder">
       				...
       				<div class="col-xs-6 text-center">
       					<div class="desktop-center clearfix">
        					...
        					<p class="hidden-xs hidden-sm"><fmt:message key="saints.landing.from" bundle="${msg}" /> <a href="#"><fmt:message key="saints.landing.pricerite" bundle="${msg}" /></a> <fmt:message key="saints.landing.referral" bundle="${msg}" /></p>
       					</div>
       				</div>
       			</div>
       		</div>
						...
						<div class="tab-content carousel-inner clearfix" role="listbox">
							<div role="tabpanel" class="fna-tab-content tab-pane item active" id="navtabs-1">
								<div class="so-fna-content">
									...
									<h3 class="visible-md visible-lg  tab-head"><fmt:message key="saints.landing.presentation.here" bundle="${msg}" /></h3>
									 <p><fmt:message key="saints.landing.presentation.here.content" bundle="${msg}" /></p>
								</div>
							</div>
							...
							<div role="tabpanel" class="fna-tab-content tab-pane item" id="navtabs-3">
								<div class="so-fna-content">
									...
									<h3 class="visible-md visible-lg tab-head"><fmt:message key="saints.landing.presentation.make" bundle="${msg}" /></h3>
			...
			<div class="blog">
				<div class="hidden-md hidden-lg">
					...
					<div class="btn-holder">
						<button class="savie-regular-btn"><fmt:message key="saints.landing.blog.read" bundle="${msg}" /></button>
					</div>
				</div>
				<div class="hidden-xs hidden-sm">
					<h3 class="text-center"><fmt:message key="saints.landing.blog.read" bundle="${msg}" /></h3>
					<div class="gray-divide"></div>
					...
					<div class="blogs-holder clearfix fwd-container-limit">
						<div class="blogs first">
							...
							<div class="orange-overlay text-center">
								<p class="title"><fmt:message key="saints.landing.blog.title1" bundle="${msg}" /></p>
								<span><fmt:message key="saints.landing.blog.span1" bundle="${msg}" /></span>
								<p class="definition"><fmt:message key="saints.landing.blog.definition1" bundle="${msg}" /></p>
						...
						<div class="blogs">
							...
							<div class="orange-overlay text-center">
								...
								<p class="definition"><fmt:message key="saints.landing.blog.definition2" bundle="${msg}" /></p>
						...
						<div class="blogs last">
							...
							<div class="orange-overlay text-center">
								<p class="title"><fmt:message key="saints.landing.blog.title4" bundle="${msg}" /></p>
								<span><fmt:message key="saints.landing.blog.span4" bundle="${msg}" /></span>
								<p class="definition"><fmt:message key="saints.landing.blog.definition4" bundle="${msg}" /></p>
