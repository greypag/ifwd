				...
				<div class="cont clearfix">
					<div>
						...
						<div class="fna-input-bar clearfix">
							...
							<input type="text" name="frm-fna-name" value="Chan Tai Man" class="frm-fna-name" data-mirror-fld="frm-fna-name-mob" data-frm-fld="name" onkeypress=" return alphaOnly(event);" maxlength="50" readonly>
							</div>
						...
						<div class="step6">
							<div class="cont">
								...
								<div class="q4c mob-view">
									<h4><span class="q-num">4c</span>What is your average monthly expenses<br>including but not limited to living expenses,<br>household expenses, including dependentâs<br>expenses mortgage payment and regular<br>payment in the past 2 years?</h4>
									<div class="fna-error-box">
										<span class="fna-error-msg text-red"></span>
									</div>
