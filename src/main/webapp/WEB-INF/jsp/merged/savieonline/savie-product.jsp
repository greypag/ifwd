					...
					<div class="expander">
						<div class="row">
							...
							<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 fna-product-col-obj">
								...
								<a href="javascript:void(0);" class="fna-btn-sel-product"> <img src="<%=request.getContextPath()%>/resources/images/onlinesavieFNA/iFWD_icon01.png">Select This Product</a>
