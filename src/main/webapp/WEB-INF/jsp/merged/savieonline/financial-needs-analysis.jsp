						...
						<div class="step5">
							<div class="cont">
								...
								<div class="q4b mob-view mob-hide">
									...
									<div class="sep"></div>
									<fmt:message key="fna.question.q4b.amount" bundle="${msg}" /> <fmt:message key="label.dollar.hkd.en" bundle="${msg}" /> <input type="text" autocomplete="off" class="frm-fna-q4b-amount" onkeypress=" return isNumeric(event);" maxlength="10" data-mirror-fld="frm-fna-q4b-amount-mob" data-frm-fld="q4_b_amount" data-type="int" data-allowzero="true" tabindex="-1"> <fmt:message key="label.dollar.hkd.cn" bundle="${msg}" />
						...
						<div class="step6">
							<div class="cont">
								...
								<div class="q4c mob-view">
									...
									<fmt:message key="fna.question.q4c.month" bundle="${msg}" /> <input type="text" autocomplete="off" class="frm-fna-q4c" data-mirror-fld="frm-fna-q4c-mob" data-frm-fld="q4_c" data-type="int" data-allowzero="true" onkeypress=" return isNumeric(event);" maxlength="10" tabindex="-1" > <fmt:message key="fna.question.q4c.hkd" bundle="${msg}" />
