...
<form name="frmTravelGetQuote" id="frmTravelGetQuote" commandName="travelQuote" action="<%=request.getContextPath()%>/${language}/annual-travel-insurance/quote" method="post" onsubmit="return flightValidateMobTravel();">
  ...
  <div class="container pad-none">
    ...
    <div class="center wow fadeInDown">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align:left;">
        <div class="hidden-xs hidden-sm"><span style="color: #f68a1d;">*</span> Round-trip Round-trip Round-trip Round-trip Round-trip Round-trip Round-trip Round-trip Round-trip Round-trip Round-trip Round-trip Round-trip Round-trips</div>
...
<div style="background-color:#071D2A;text-align:center;padding-top: 20px;padding-bottom: 20px;">
    <div class="container pad-none">
...
<section id="bottom-form" class="hidden-sm hidden-xs">
  <div class="container bmg_flighttravel_main_container">
    <div class="row">
    <form name="frmTravelGetQuote" id="frmTravelGetQuote" commandName="travelQuote" action="<%=request.getContextPath()%>/${language}/annual-travel-insurance/quote" method="post" onsubmit="return flightValidateBtmTravel();">
      <div class="col-lg-12 col-md-12 pad-none-lg slide-form">
