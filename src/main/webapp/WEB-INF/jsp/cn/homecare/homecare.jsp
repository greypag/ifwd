...
<section id="main-slider" class="no-margin"> 
  <!--banner--> 
  <img src="resources/images/slider/home_cn_m.jpg" alt="" class="img-responsive hidden-lg hidden-md"  /> 
  <!--banner-->
...
<div class="carousel slide hidden-xs hidden-sm">
            <div class="carousel-inner">
                ...
                <div class="row">
            <form:form name="getHomeQuote" id="getHomeQuote" action="getHomePlan" method="post" modelAttribute="homeCarelPlan">
              ...
              HomeCareQuetionaries quetionList = (HomeCareQuetionaries) itr.next();
                %>
                        ...
                        <div class="col-lg-4 col-md-4 pad-none">
                            <h4>      <%=quetionList.getQuetion() %>
                            </h4>
                            
                                  <input type="hidden" id="lblCount" value="<%=lst.size() %>"></input>
                              <label class="radio radio-warning radio-inline">
							  
                          <input name="home_situated<%=quetionList.getQid() %>" id="inlineDeskRadio1<%=quetionList.getQid() %>" data-id="btm" class="plan" value="<%=quetionList.getAnswer1() %>" checked="" type="radio">
                          <label for="inlineDeskRadio1<%=quetionList.getQid() %>"> <span> <%=quetionList.getAnswer1() %> </span> </label>
                          </label>
                          
                            <label class="radio radio-warning radio-inline">
                          <input name="home_situated<%=quetionList.getQid() %>" id="inlineDeskRadio2<%=quetionList.getQid() %>" data-id="btm" class="plan" value="<%=quetionList.getAnswer2() %>" checked="" type="radio">
                          <label for="inlineDeskRadio2<%=quetionList.getQid() %>">  <span> <%=quetionList.getAnswer2() %></span> </label>
                          </label>
                        </div>
                <%} i++; %>
                        ...
                        <div class="col-lg-4 col-md-4">
                           ...
                           <button type="submit" class="border-radius btn btn-primary get-btn get-btn-home" onclick="return msgAlertDesk()">立即報價</button>
                           
                        </div>
                        <div class="clearfix"></div>
                        <p class="pad-none">*適用於實用面積一千尺以下單位
                        </p>
                    </div>
				</form:form>
</div>
...
<form:form name="getHomeQuote" id="getHomeQuote" action="getHomePlan" method="post" modelAttribute="homeCarelPlan">
  <div class="col-lg-12 col-md-12 hidden-lg  hidden-md pad-none homecare">
        ...
        <h4><%=quetionList.getQuetion() %></h4>
        <input type="hidden" id="lblCount" value="<%=lst.size() %>"></input>
         <label class="radio radio-warning radio-inline">
		                           
						  <input name="home_situated6<%=quetionList.getQid() %>" id="inlineDeskRadio9<%=quetionList.getQid() %>" data-id="btm" class="plan" value="<%=quetionList.getAnswer1() %>" checked="" type="radio">

                          <label for="inlineDeskRadio9<%=quetionList.getQid() %>">  <span> <%=quetionList.getAnswer1() %> </span> </label>
                          </label>
                          
                            <label class="radio radio-warning radio-inline">
											
                          <input name="home_situated6<%=quetionList.getQid() %>" id="inlineDeskRadio10<%=quetionList.getQid() %>" data-id="btm" class="plan" value="<%=quetionList.getAnswer2() %>" checked="" type="radio">

                          <label for="inlineDeskRadio10<%=quetionList.getQid() %>">  <span>  <%=quetionList.getAnswer2() %> </span> </label>
                          </label>
     ...
     <div class="btn-box">
    <h3 class="text-center"><button type="submit" class="bdr-curve btn btn-primary nxt-btn" onclick="return msgAlertDesk()">立即報價</button></h3>
  </div>
...
<div class="row hidden-xs hidden-sm">
  <div class="col-lg-12  home-features">
    <div class="col-md-6 col-lg-6 text-center"> <img  src="resources/images/homecare1.png" alt=""  /> </div>
    ...
    <div class="col-md-6 col-lg-6 text-center"> <img src="resources/images/homecare2.png" alt=""  /> </div>
    <div class="clearfix"></div>
    <br>
    <div class="col-md-6 col-lg-6 text-center"> <img src="resources/images/homecare3.png" alt=""  /> </div>
    <div class="col-md-6 col-lg-6">
       <div class="content">
        <h2>保障您的家居，還有您和您的家人!</h2>
        <p class="h4-3">易安心家居保的個人法律責任保險為您和您的家人提供保障。一旦有人因您或您的家人受到意外的身體傷害或財物損失，不論發生在世界任何地方*，我們都會提供高達港幣$5,000,000之法律保障。
<br>
*惟訴訟必須由香港法庭處理 </p>
        <a href="" class="h4-4 scrollToTop">了解更多</a> </div>
    </div>
...
<div class="row mob-features hidden-lg hidden-md">
  <div class="col-xs-4 col-sm-4 text-center"> <img class="img-responsive" src="resources/images/homecare1.png" alt=""  /> </div>
  <div class="col-xs-8 col-sm-8">
    <div>
      <h2 class="h2-3">保障您所珍愛的一切</h2>
      <p class="h4-3">您將受到全險綜合保障，涵蓋家居財物高達港幣$500,000，私人財物高達港幣$100,000，其中每件私人財物最高賠償額為港幣$10,000。購買易安心家居保，您的傢俬以至雪櫃裡的食物都一律受到保障。 </p>
      <a href="" class="h4-4 scrollToTop">了解更多</a> </div>
  </div>
  <div class="clearfix"></div>
  <br>
  <div class="col-xs-4 col-sm-4 text-center"> <img class="img-responsive" src="resources/images/homecare2.png" alt=""  /> </div>
  <div class="col-xs-8 col-sm-8">
    <div>
      <h2 class="h2-3">保障，豈止重新添置家居物品</h2>
      <p class="h4-3">假如您的家居因意外損失或毀壞變得不宜居住，我們會為您支付另覓臨時居所的費用，每年高達港幣$50,000或每天高達港幣$1,000，助您的生活重拾正軌。</p>
      <a href="" class="h4-4 scrollToTop">了解更多</a> </div>
  </div>
  <div class="clearfix"></div>
  <br>
  <div class="col-xs-4 col-sm-4 text-center"> <img class="img-responsive" src="resources/images/homecare3.png" alt=""  /> </div>
  <div class="col-xs-8 col-sm-8">
    <div>
      <h2 class="h2-3">保障您的家居，還有您和您的家人!</h2>
      <p class="h4-3">易安心家居保的個人法律責任保險為您和您的家人提供保障。一旦有人因您或您的家人受到意外的身體傷害或財物損失，不論發生在世界任何地方*，我們都會提供高達港幣$5,000,000之法律保障。
<br>
*惟訴訟必須由香港法庭處理</p>
      <a href="" class="h4-4 scrollToTop">了解更多</a> </div>
      ...
      <div class="col-xs-12 col-sm-4 col-md-4 pad-none ">
        <div class="recent-work-wrap-mid wrap text-center">
          <div class="recent-work-inner"> <img src="resources/images/secure.png" alt=""  />
            <h1>安全，可靠</h1>
            <p>富衛香港的壽險及一般保險營運機構均獲國際評級機構授予卓越的財務實力評級 -- 其中獲「穆迪」 評為A3級 及「惠譽國際」評為A級。
              <br>
            </p>
          </div>
        </div>
    ...
    <div>
      <div class="col-lg-4 col-md-4 pad-none">
        <div class="services-wrap service-bx1">
          <div> <img class="img-responsive bdr-img" src="resources/images/home4.png" alt="">
            <h3><a href="http://blog.fwd.com.hk/" target="_blank"> 傳家之寶收藏法 <i class="fa fa-caret-right"></i></a> </h3>
      ...
      <div class="col-lg-4 col-md-4 pad-none">
        <div class="services-wrap service-bx2">
          <div> <img class="img-responsive bdr-img" src="resources/images/home5.png" alt="">
            <h3><a href="http://blog.fwd.com.hk/"  target="_blank"> 打造型格窩居 <i class="fa fa-caret-right"></i> </a></h3>
      ...
      <div class="col-lg-4 col-md-4 pad-none">
        <div class="services-wrap service-bx3">
          <div> <img class="img-responsive bdr-img" src="resources/images/home6.png" alt="">
            <h3><a href="http://blog.fwd.com.hk/" target="_blank"> 預防家居意外 <i class="fa fa-caret-right"></i></a> </h3>
...
<form:form name="getHomeQuote" id="getHomeQuote" action="getHomePlan" method="post"	modelAttribute="homeCarelPlan">
                ...
                %>
						...
						<input type="hidden" id="lblCount" value="<%=lst.size() %>"></input>
								...
								<input name="home_situated<%=quetionList.getQid() %>" id="inlineDeskRadio1<%=quetionList.getQid() %>" data-id="btm" class="plan" value="personal" checked="" type="radio">
                          <label for="inlineDeskRadio1<%=quetionList.getQid() %>"> <span> <%=quetionList.getAnswer1() %> </span> </label>
                          </label>
								
                          <input name="home_situated2<%=quetionList.getQid() %>" id="inlineDeskRadio5<%=quetionList.getQid() %>" data-id="btm" class="plan" value="personal" checked="" type="radio">
                          <label for="inlineDeskRadio5<%=quetionList.getQid() %>">  <span> <%=quetionList.getAnswer1() %> </span> </label>
                          </label>
                          
                            <label class="radio radio-warning radio-inline">
							
							<input name="home_situated<%=quetionList.getQid() %>" id="inlineDeskRadio2<%=quetionList.getQid() %>" data-id="btm" class="plan" value="personal" checked="" type="radio">
                          <label for="inlineDeskRadio2<%=quetionList.getQid() %>">  <span> <%=quetionList.getAnswer2() %></span> </label>
                          </label>
						  
                          <input name="home_situated2<%=quetionList.getQid() %>" id="inlineDeskRadio6<%=quetionList.getQid() %>" data-id="btm" class="plan" value="personal" checked="" type="radio">
                          <label for="inlineDeskRadio6<%=quetionList.getQid() %>">  <span>  <%=quetionList.getAnswer2() %> </span> </label>
                          </label>
					...
					<%} i++; %>
                        <div class="col-lg-4 col-md-4">
                            ...
                            <button class="border-radius btn btn-primary  get-btn get-btn-home" onclick="return msgAlertDesk();">立即報價</button>
                        </div>
                        <div class="clearfix"></div>
                        <p class="pad-none">*適用於實用面積一千尺以下單位
                        </p>
