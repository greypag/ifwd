...
<section>
   <div id="cn" class="container">
    <div class="row">
      <form name="homeCarepaymentForm" id="homeCarepaymentForm" onsubmit="confirmPayment(this);" method="post" >
...
<div id="tr-wizard" class="shop-tracking-status">
  <div class="order-status">
        <div class="order-status-timeline"> 
          ...
          <div class="order-status-timeline-completion order-status-timeline-completion c3"></div>
        </div>
        ...
        <div class="image-order-status image-order-status-delivered  img-circle act"> <span class="status color2">您的賬單</span>
        ...
        <div class="container pad-none bdr ur-opt-content gray-bg3">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pad-none white-bg1"> <br>
...
${homeCareDetails.getApplicantStreetName()} ${homeCareDetails.getApplicantDistrict()} </td>
                  </tr>
                  <tr>
                    <td  class="h2-1 ">投保居所地址</td>
                    <td class=" h4-5 ">
${homeCareDetails.getaRoom()}/${homeCareDetails.getaFloor()},  ${homeCareDetails.getaBlock() },
${homeCareDetails.getaBuilding()},
${homeCareDetails.getaEstate() },${homeCareDetails.getaStreetNo() }
${homeCareDetails.getaStreetName() }
${homeCareDetails.getaDistrict()}, ${homeCareDetails.getaArea() }</td>
                  </tr>
                  <tr>
                   ...
                   <tr>
                    ...
                    <td class=" h4-5 ">From ${effectiveDate } to ${effectiveEndDate}</td>
                  </tr>
                  <tr>
                    <td class="pad-none"><span class="h4-4-orange-b pad-none">所需保費 </span></td>
                    <td><span class="h4-4-orange-b ">${totalDue}</span></td>
                  </tr>
                </tbody>
              </table>
            </div>
            <div class="col-lg-6 col-xs-6 col-sm-6 col-md-6 pad-none hidden-sm hidden-xs">
           <h4 class="h4-trav-full col-xs-offset-8"><a href="homecare-plan-details.html">更改資料</a></h4>
              <table class="table activation-form margin-left-2">
                <tbody>
                  <tr>
		...
		<input type="hidden" name="merchantId"
						...
						<input type="hidden" name="lang" value="${createdPolicy.getLang()}">
	...
	<tbody>
		<tr class="control-group">
			...
			<td class="col-lg-8" colspan="2"><div class="controls">
                  <div> <img src="resources/images/payment.png" alt=""> </div>
                </div></td>
        </tr>
        <tr>
        ...
        <tr class="control-group">
			...
			<td colspan="2"><div class="controls">
                    ...
                    <input id="cardnumber" name="cardNo" type="text" class="input-block-level" maxlength="16" data-min="16" pattern="" title="" required="" placeholder="信用卡號碼" onkeyup="validatecardnumber(this.value)" onBlur="chkMinLength(this.value);" onkeypress="return isNumeric(event)">
        ...
        <tr class="control-group">
			...
			<td>
             <select class="input-block-level soflow select-style" id="month" name="epMonth">
                      <option>月</option>
                      <option>1</option>
                      <option>2</option>
                      <option>3</option>
            ...
            <td><select class="input-block-level soflow select-style" id="year" name="epYear">
                      <option>月</option>
                      <option>2015</option>
                      <option>2016</option>
                      <option>2017</option>
        ...
        <td><span id="erryear" class="error-msg"></span></td>
         ...
         <tr class="control-group">
			...
			<td colspan="2">  <div class="controls">
                    <input id="holdername" name="cardHolder" type="text" class="input-block-level" pattern="" title="" required="" placeholder="持卡人名稱" onblur="replaceAlpha(this);" onkeypress="return alphaOnly(event);">
         ...
         <tr class="control-group">
			...
			<td><div class="controls">
                    <input id="seccode" name="securityCode" type="password" class="input-block-level" autocomplete="off" maxlength="3" pattern="" title="" required="" placeholder="CVV" onblur="replaceAlphaNumeric(this);" onkeypress="return isAlphaNumeric(event);">
        ...
        <tr class="control-group">
          ...
          <div class="declaration-content margin-left-small">
            <div class="checkbox">
              ...
              <label for="checkbox3"> 本人現授權富衛保險有限公司從我上述指定的信用卡賬戶扣除此保險所應繳之保費。 </label>
                 <div class="clearfix"></div>
            </div>
          ...
          <!--   <div class="checkbox">
		   ...
		   <input type="button" class="bdr-curve btn btn-primary bck-btn" value="返回">
          ...
          <input type="submit" class="bdr-curve btn btn-primary nxt-btn margin-left"  value="確認付款">
           
            </div>
             <br>  <br> 
            <div class="pad-none hidden-md hidden-lg">
            
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pad-none">  <a href="travel-plan-details-cn.html" class="bdr-curve btn btn-primary bck-btn col-xs-5 col-sm-5 text-center">返回 </a> </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"> 
            <input type="submit" class="bdr-curve btn btn-primary nxt-btn margin-left col-xs-6 col-sm-6 text-center"
                                    value="Pay Now"></div>
