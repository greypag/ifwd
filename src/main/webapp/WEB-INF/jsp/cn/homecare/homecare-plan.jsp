...
<div id="tr-wizard" class="shop-tracking-status">
  <div class="order-status">
        ...
        <div class="image-order-status image-order-status-new active img-circle act"> <span class="status">您的選擇</span>
          <div class="icon">1</div>
        </div>
        
        <div class="image-order-status image-order-status-intransit  img-circle disabled"> <span class="status"> 個人資料</span>
          <div class="icon">2</div>
        </div>
        <div class="image-order-status image-order-status-delivered  img-circle disabled"> <span class="status">總結及付款</span>
          <div class="icon">3</div>
        </div>
        <div class="image-order-status image-order-status-completed  img-circle disabled"> <span class="status lst-status">確認保單</span>
                   ...
                   <div class="fwdpanel">
                      <div class="fwdpanel-heading">
                        <h4 class="uline benefits">
                          <span><a href="#" class="fwdpanel-minimize uline color-wht"><i class="fa fa-plus"></i>  承保範圍 </a> </span>
                        </h4> 
                      </div>
                      
                      <div class="fwdpanel-body" style="display: none;">
                     <p class="color-wht">
                        <i class="fa fa-plus"></i>住院或檢疫現金津貼 $10,000<br>							
<i class="fa fa-plus"></i> 全球緊急支援服務	<br>						
<i class="fa fa-plus"></i> 租車自負額 $5,000	<br>						
<i class="fa fa-plus"></i> 高爾夫球“一桿入洞” $3,000	<br>						
<i class="fa fa-plus"></i> 更多詳情	<br>						
</p>
                    ...
                    <div class="fwdpanel fwdpanel-primary">
                      <div class="fwdpanel-heading">
                        <h4 class="fwdpanel-title h4-4-travel margin-left">
                          <span><a href="#" class="fwdpanel-minimize"><i class="fa fa-plus"></i> 產品特點 </a> </span>
                        </h4>
                      </div>
                      <div class="fwdpanel-body" style="display: none;">
                        <p>享有高達港幣500,000 的家居物品保障</p><br>
<p>提供高達港幣5,000,000 作為業主、住戶及個人的個人法律責任及個人全球法律責任保障</p><br>
<p>保障居所內的家居財物、傢俬及電器等因火災、水浸、水渠爆裂、颱風、盜竊或意外而導致之損毀</p><br>
<p>適用於實用面積為1,000平方呎以內之家居</p><br>
                      </div>
                    </div>
                    <!-- /  Product Highlights -->
                    ...
                    <div class="fwdpanel fwdpanel-primary">
                      <div class="fwdpanel-heading">
                        <h4 class="fwdpanel-title h4-4-travel margin-left">
                          <span><a href="#" class="fwdpanel-minimize"><i class="fa fa-plus"></i>保障範圍 </a> </span>
                        </h4>
                      </div>
                      <div class="fwdpanel-body" style="display: none;">
                      
                       <h4 class="h4-2"><strong> 第一部份：家居物品全險</strong></h4>  
<p>易安心家居保為你的家居財物提供 '全面保障'，範圍包括因火災、水浸、颱風、爆炸、盜竊或意外而導致之損壞。賠償總額每年最高可達港幣500,000，每件財物最高賠償額為港幣100,000。貴重物件如珠寶首飾、金、銀、手錶、攝影器材、皮草或樂器（鋼琴除外）等，每件最高賠償額為港幣10,000，而每年最高賠償總額為港幣100,000。</p><br>
  ...
  <table id="Premium" class="table table-bordred">
	<tbody>
		...
		<tr>
			...
			因爆竊或企圖爆竊而引致損毀需更換之大門門鎖、門匙或窗戶</strong></td>
			<td>每年港幣$3,000</td>
		</tr>
		<tr>
			<td>2</td>
			<td><strong>短暫寄存保障<br />
			家居物品需短暫寄存於其他地方進行翻新、維修或清潔時所受到的意外損毀</strong></td>
			<td>每年港幣$50,000</td>
		</tr>
		<tr>
			<td>3</td>
			<td><strong>搬遷保障<br />
			家居物品在下列情況下因意外而導致損毀:<br />
			(a) 由專業搬運公司運往香港範圍內之新居; 或<br />
			(b) 以七天為上限之短暫傢具儲存處; 或<br />
			(c) 在尚未入住的新居內，以不超過兩個月為限。<br />
			(必須事先通知本公司)</strong></td>
			<td>每年港幣$50,000</td>
		</tr>
		<tr>
			<td>4</td>
			<td><strong>冷藏食物保障<br />
			冷藏食物因冰箱意外停電或故障而變壞並需重新購買之食物</strong></td>
			<td>每年港幣$5,000</td>
		</tr>
		<tr>
			<td>5</td>
			<td><strong>災場淸理費用<br />
			意外發生後，清理現場廢物之費用</strong></td>
			<td>每年港幣$10,000</td>
		</tr>
		<tr>
			<td>6</td>
			<td><strong>金錢保障<br />
			存放於家居的金錢遺失或被竊</strong></td>
			<td>每年港幣$2,500</td>
		</tr>
		<tr>
			<td rowspan="2">7</td>
		...
		<tr>
			<td>8</td>
			<td><strong>加設之裝修保障t<br />
			
住戶加設之室內裝修意外損毀</strong></td>
			<td>每件港幣$100,000</td>
		</tr>
		<tr>
			<td>9</td>
			...
			室內裝修工程期間引致家居財物意外損毀
(工程期以不超過兩個月為限)</strong></td>
			<td>每年港幣$100,000</td>
		</tr>
		<tr>
			<td rowspan="2">10</td>
			<td rowspan="2"><strong>臨時住所保障<br />
			家居因意外損毀以致不宜居住，需另覓臨時住所之費用</strong></td>
			<td>每天港幣$1,000</td>
		</tr>
		<tr>
			<td>每年港幣$50,000</td>
		...
		<tr>
			...
			投保人或家庭成員於家中因火災或盜竊而引致死亡</strong></td>
			<td>每人港幣$50,000</td>
		</tr>
		<tr>
			<td>每年港幣$200,000</td>
  ...
  <h4 class="h4-2"><strong> 第二部份： 個人法律責任保險	</strong></h4>  
<p>如你或同住的家庭成員在以下情況因疏忽而導致他人身體受傷或財物損失需負上法律責任及作出金錢賠償時，本計劃可提供高達港幣5,000,000之保障。惟訴訟必須由香港法庭處理:</p><br>
<p>a) 以住戶身份佔用家居<br>
b) 以業主身份(包括所在大廈公共地方)<br>
c) 以個人身份(全球保障)<br>
法律責任更包括保障貴為租客的你對業主之樓宇結構固定裝置和建設的損毀。
</p>
                      </div>
                    </div>
                    <!-- / Summary of Coverage -->
    ...
    <!-- / Excess limit -->
                    ...
                    <div class="fwdpanel fwdpanel-primary">
                      <div class="fwdpanel-heading">
                        <h4 class="fwdpanel-title h4-4-travel margin-left">
          <span><a href="#" class="fwdpanel-minimize"><i class="fa fa-plus"></i> 保費表（港幣） </a> </span>
                        </h4>
                      </div>
                      <div class="fwdpanel-body" style="display: none;">
		...
		<tr>
			...
			<td>隨第一部份免費附送</td>
                    ...
                    <div class="fwdpanel fwdpanel-primary">
                      <div class="fwdpanel-heading">
                        <h4 class="fwdpanel-title h4-4-travel margin-left">
                          <span><a href="#" class="fwdpanel-minimize"><i class="fa fa-plus"></i> 主要不受保項目</a> </span>
                        </h4>
                      </div>
                      <div class="fwdpanel-body" style="display: none;">
                     <p>
                    ...
                    <div class="fwdpanel fwdpanel-primary">
                      <div class="fwdpanel-heading">
                        <h4 class="fwdpanel-title h4-4-travel margin-left">
                          <span><a href="#" class="fwdpanel-minimize"><i class="fa fa-plus"></i>自負金額</a> </span>
                        </h4>
                      </div>
                      <div class="fwdpanel-body" style="display: none;">
	...
	<tbody>
		...
		<tr>
			...
			<td colspan="2">第三者財物損失之自負金額為每次事故賠償額之首港幣500</td>
			  ...
			  <h4 class="h4-4  hidden-sm hidden-xs"><a href="">下載小冊子</a></h4>
             <!--Full coverage end -->
          </div> 
		  ...
		  <form:form name="frmTravelPlan" id="frmTravelPlan"
				action="getYourHomeCareDetails" method="post" modelAttribute="getYoursDetails">
            <div class="wd2">
              <div class="pull-left">
            ...
            <div class="form-container">
              ...
              <div class="travel-italic"><a href="" class="sub-link" data-toggle="modal" data-target=".bs-promo-modal-lg"><i>如何取得推廣編號?</i></a></div>
            </div>
            ...
            <input type="hidden" name="referralName" id="referralName" value="${planQuote.getReferralName()}">
             ...
             <input type="hidden" name="answer2" value="${answer2}">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pull-left"><button onclick="BackMe();" class="bdr-curve btn btn-primary bck-btn">上一頁 </button> </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pull-right"> <button class="bdr-curve btn btn-primary nxt-btn" onclick="return pageValidate();"> 下一頁 </button> </div>
...
<h5 class="col-sm-6 col-xs-6 padding7"><a href="" class="sub-link" data-toggle="modal" data-target=".bs-promo-modal-lg"><i>如何取得推廣編號?</i></a></h5>
<div class="clearfix"></div>

<div class="form-group col-sm-12 col-xs-12">
                <div class="input-group"> 
                  <input name="" type="text" class="form-control placeholder-fl"  placeholder="eg.FWD789">
                  <span class="input-group-addon in"><span class="apply">使用</span></span>
                </div>
              </div>
</div>
...
<div class="row-fluid hidden-lg hidden-md text-center">
 <div class="btn-box">
      <h3 class="text-center"><a href="http://blog.fwd.com.hk" target="_blank">博客</a></h3>
  </div>
