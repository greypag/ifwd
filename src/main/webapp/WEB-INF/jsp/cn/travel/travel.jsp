			                 ...
			                 <div class="plan_spinner_desk" id="personal_plan_desk_spinner">
			                   ...
			                   <div class="col-lg-6">
			                     <div class="input-group number-spinner none-bd" > <span class="input-group-btn data-dwn">
			                       ...
			                       <input type="text" name="totalPersonalTraveller" class="form-control text-center drop-down-plus wd4 input-number" value="0" data-min="0" data-max="15" id="txtTravellersDesk" readonly>
          ...
          <div class="col-xs-8 col-sm-8">
           ...
           <div class="col-xs-4 col-sm-4">
            <div class="input-group number-spinner none-bd "> 
              ...
              <input type="text" class="form-control text-center drop-down-plus input-number" name="totalPersonalTraveller" value="0" data-min="0" data-max="15" id="txtTravellersMob" readonly />
              <span class="input-group-btn data-up ">
          ...
          <div class="col-xs-8 col-sm-8">
           ...
           <div class="col-xs-4 col-sm-4">
            <div class="input-group number-spinner none-bd "> 
              ...
              <input type="text" class="form-control text-center drop-down-plus input-number" value="0" data-min="0" data-max="15" id="txtOtherMob" readonly/>
              <span class="input-group-btn data-up ">
