...
<section>
 <div id="cn" class="container">
    <div class="row">
     <form:form name="freeFlightForm" id="freeFlightForm"
				modelAttribute="createFlightPolicy"  method="post" onsubmit="return createFlightFnc(this);">
        ...
        <input type="hidden" name="planSelected" value="${planDetailsForm.getPlanSelected()}">
        <div class="container ">
		...
		<c:if test="${ not empty errorMessage}">
          ...
          <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 pad-none white-bg1"> <br>

           <% if (authenticate.equals("false")|| authenticate.equals("direct")) { %>

            <h3 class="margin-left-2 h2-3-existing-fwd-head hidden-sm hidden-xs">FWD eServices現有會員？</h3>


            <h3 class="margin-left-2 h2-3-existing-fwd-head hidden-lg hidden-md">FWD eServices現有會員？</h3>
               ...
               <a href="#" class="col-lg-5 col-md-5 col-sm-5 col-xs-5 btn-box-2 margin-left-2 color4" data-toggle="modal" data-target=".bs-example-modal-lg">登入</a>
               <br> 
            ...
            <table class="table activation-form margin-left-2">
              <tbody>
                <tr>
                  ...
                  <td colspan="2" class="pad-none"><h3 class="black-bold pad-none">申請人資料</h3></td>
                </tr>
                <tr>



                  <td  class="col-sm-4 pad-none"><label for="inputFullName" class="control-label bold-500">英文全名</label></td>
                  <td class="pad-none"><input type="text" name="fullName" class="form-control" value="${userDetails.getFullName()}" id="inputFullName" placeholder="英文全名(與香港身份證號碼)" onblur="replaceAlpha(this);" onkeypress="return alphaOnly(event);" maxlength="100" />





                    <span id="fullname" style="display:none">
                    <label  class="text-red">請輸入 姓名 和 請以英文輸入</label>
                    </span> <span id="fullnameinvalid" style="display:none">
                    <label  class="text-red">請輸入 姓名 和 請以英文輸入</label>
                    </span></td>
                </tr>
                ...
                <tr>
									...
									<td class="pad-none"><input type="text" name="hkid"
										...
										id="txtAppHkid" placeholder="X1234567"> <span
                ...
                <tr>
                  ...
                  <td  class="pad-none"><label for="inputMobileNo" class="control-label bold-500">手機號碼</label></td>
                  <td class="pad-none"><input type="text" name="mobileNo" class="form-control" value="${userDetails.getMobileNo().trim()}" id="inputMobileNo" placeholder="手機號碼" onkeypress="return isNumeric(event)" onblur="replaceNumeric(this);" maxlength="8" />





                    <span id="mobileNo" style="display:none">
                    <label class="text-red">請輸入 聯絡電話</label>
                    </span> <span id="mobilenoinvalid" style="display:none">
                    <label class="text-red">請以數字輸入 聯絡電話</label>
                    </span></td>
                </tr>
                <tr>
                  ...
                  <td  class="pad-none"><label for="inputEmailId" class="control-label bold-500">電郵地址</label></td>
                  <td class="pad-none"><input  class="form-control" value="${userDetails.getEmailAddress().trim()}" name="emailAddress" id="inputEmailId" placeholder="電郵地址"  maxlength="50" >




                    <span id="emailid" style="display:none">
                     <label class="text-red">請輸入電郵地址</label>
                    </span> <span id="emailidinvalid" style="display:none">
                    <label class="text-red">請輸入正確/有效的 電郵地址</label>
                    </span></td>
                </tr>
            ...
            <div class="gray-bg3-wid">
              <table class="table plandetail-form margin-left-2" id="input-white">
                <tbody>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td  class="col-sm-4 pad-none"><label class="control-label bold-500">用戶名稱</label></td>
                    <td class="pad-none"><input type="text" name="userName" class="form-control btm-pad-10" id="inputRegUserName" placeholder="用戶名稱"><span id="errRegUser" class="text-red"> </span></td>
                  </tr>
                  <tr>

                    <td  class="pad-none"><label class="control-label bold-500">個人密碼</label></td>
                    <td class="pad-none"><input type="password" class="form-control btm-pad-10"  name="password" id="inputRegPass" placeholder="個人密碼"><span id="errRegPass" class="text-red"> </span></td>
                  </tr>
                  <tr>


                    <td  class="pad-none"><label class="control-label bold-500">確認密碼</label></td>
                    <td class="pad-none"><input type="password" class="form-control btm-pad-10" name="password"  id="inputRegCPass" placeholder="確認密碼"><span id="errRegCPass" class="text-red"> </span></td>
                  </tr>
                </tbody>
              </table>
            </div>
            <% } %>
              ...
              <h3 class="black-bold pad-none">受保人資料<br> </h3>
 ...
 <div class="row ">
                <div class="col-xs-6 col-md-6">
                  <label class="bold-500">英文全名</label>
                  <input type="text" name="adultName" id="txtAdFullName${inx}" class="form-control " placeholder="英文全名(與香港身份證號碼)" onblur="replaceAlpha(this);" onkeypress="    return alphaOnly(event);" maxlength="100" />
                  <span id="fullname1"  class="text-red">




                  </span> <span id="errtxtAdFullName${inx}" class="text-red">
                  </span> </div>

                <div class="col-xs-6 col-md-6">
                  <label class="pad-left1 bold-500">身份證號碼</label>

                  <input id="txtInsuHkid${inx}" name="adultHKID" class="form-control" placeholder="X1234567" value=""  />
              ...
              <div class="row top-mrg-10">
                ...
                <div class="col-xs-6 col-md-6">
                  ...
                  <select id="adultsselectBenificiary${inx}"onchange="activeDiv('adultsbenificiaryId${inx}','adultsselectBenificiary${inx}')"
       ...
       <c:forEach var="relationshipCodeList" items="${mapRelationshipCode}">
				 ...
				 <div id="adultsbenificiaryId${inx}" class="hide">
						<div class="col-xs-6 col-md-6">
							<label class="bold-500">受益人全名</label> <input type="text"
								name="adultBenificiaryFullName" id="adultBenefitiaryId${inx}"
								value="" class="form-control " placeholder="受益人全名"
           ...
           <!-- Child -->
            <input type="hidden" name="totalChildTraveller" value="${totalChildTraveller}" id="totalCountOfChild">
		...
		<div id="childtraveller">
            <div class="col-xs-12 col-sm-12 col-md-12 pad-15 insure-travel">
              <h4 class="color1 top-mrg-10">配偶 <c:out value="${inx}"></c:out></h4>
              <div class="row ">
                <div class="col-xs-6 col-md-6">
                  <label class="bold-500">英文全名</label>
                  <input type="text" name="childName" id="txtChldFullName${inx}" value="" class="form-control " placeholder="英文全名(與香港身份證號碼)" onblur="replaceAlpha(this);" onkeypress="    return alphaOnly(event);" maxlength="100" />
                  <span id="errtxtChldFullName${inx}" class="text-red"></span>
                   </div>
                <div class="col-xs-6 col-md-6">
                  <label class="pad-left1 bold-500">身份證號碼</label>
                  <input id="txtChldInsuHkid${inx}" name="childHKID" class="form-control" placeholder="X1234567" value="">
                  ...
                  <span id="errselectChildbenificiary${inx}" class="text-red"></span>
					...
					<div id="childbenificiaryId${inx}" class="hide">
						...
						<div class="col-xs-6 col-md-6">
							...
							<span id="errtxtchildInsuHkid${inx}" class="text-red">
							</span>
						</div>
					</div>
				</div>
           ...
           <input type="hidden" name="totalOtherTraveller" value="${totalOtherTraveller}" id="totalCountOther">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 pad-15 insure-travel">
              <h4 class="color1 top-mrg-10">子女 <c:out value="${inx}"></c:out></h4>
              ...
              <div class="row ">
                <div class="col-xs-6 col-md-6">
                  <label class="bold-500">英文全名</label>
                  <input type="text" name="otherName" id="txtOtherFullName${inx}" value="" class="form-control " placeholder="英文全名(與香港身份證號碼)" onblur="replaceAlpha(this);" onkeypress="    return alphaOnly(event);" maxlength="100" />
                ...
                <div class="col-xs-6 col-md-6">
                  ...
                  <input id="txtOtherInsuHkid${inx}" name="otherHKID" class="form-control" placeholder="X1234567" value="" >
              ...
              <div class="row top-mrg-10">
                <div class="col-xs-6 col-md-6">
                  <label class="bold-500">年齡</label>
                  <select name="otherAgeRange" id="selectOtherAgeRange${inx}" class="soflow">
                ...
                <select id="otherSelectBenificiary${inx}" name="otherBeneficiary"	onchange="activeDiv('otherbenificiaryId${inx}','otherSelectBenificiary${inx}')"
												class="form-control soflow">
                    <option value="SE">個人遺產</option>
                   <c:forEach var="relationshipCodeList" items="${mapRelationshipCode}">
                   ...
                   <span id="benificiary" style="display: none"> 
                   <label style="color: red">請輸入受益人的英文全名。</label>
					</span>
                </div>
          ...
          <div class="declaration-content">
              <div class="checkbox">
                ...
                <label for="checkbox1"> 本人已參閱及明白保障範圍並在此聲明:-<br>
                  i. <span class="margin-left-2"></span>聲明上列資料及本人所知一切據實填報 ;<br>
          ...
          <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 gray-bg pad-none wht-bg3"> 
            <!--mob-hidden-->
            <div class="hidden-sm hidden-xs">
              <div class="wd2">
                ...
                <div class="pull-right">
                  <div class="text-left pad-right1 h2-2 h2">
                    <div class="hk"><!-- 港幣 -->
                      <div class="flightcare-hk"> <%-- ${planDetailsForm.getTotalDue()} --%></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="orange-bdr"></div>
                ...
                <h3 class="txt-bold">出發日期 <span class="span2 uline"><a href="flight">更改</a></span> </h3>
                 <input type="hidden" name="departureDate" value="${planDetailsForm.getDepartureDate()}">
                <h4>${planDetailsForm.getDepartureDate()}</h4>
                <h3 class="txt-bold">回程日期<span class="span2 uline"><a href="flight">更改</a></span> </h3>
                <input type="hidden" name="returnDate" value="${planDetailsForm.getReturnDate()}">
               	<h4>${planDetailsForm.getReturnDate()}</h4>
                <h3 class="txt-bold">同行人數 <span class="span2 uline"><a href="flight">更改</a></span></h3>
				...
				<input type="hidden" name="otherInput" value="${planDetailsForm.getTotalOtherTraveller()}">
				<input type="hidden" name="childInput" value="${planDetailsForm.getTotalChildTraveller()}">
                <br>
                <input type="hidden" name="days" value="${planDetailsForm.getDays()}">
				<h3 class="txt-bold">
            ...
            <!--mob-hidden-->
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pull-left"><a href="#" onclick="BackMe();" class="bdr-curve btn btn-primary bck-btn">上一頁 </a> </div>
...
<input type="submit" class="bdr-curve-none btn btn-primary nxt-btn " value="下一頁"/>
        ...
        以上資料只作參考用途。詳情請查看
        <a class="sub-link" href="resources/policy-provisions-pdf/FlightCare_Provisions_Mar_2015.pdf" target="_blank">
       保單條款</a>。有關條款細則的詳細資料,請聯絡您的理財顧問或致電我們的24小時熱線3123 3123與客戶服務主任聯絡。
