                      ...
                      <div class="plan_spinner_desk" id="family_plan_desk_spinner">
                        ...
                        <div class="col-lg-6">
                          <div class="input-group number-spinner none-bd" > <span class="input-group-btn data-dwn">
                            ...
                            <input type="text" name="totalChildTraveller" class="form-control text-center drop-down-plus wd4 input-number" value="0" data-min="1" data-max="14" id="txtChildDesk" readonly>
                            <span class="input-group-btn data-up ">
                        ...
                        <div class="col-lg-6">
                          <div class="input-group number-spinner none-bd" > <span class="input-group-btn data-dwn">
                            ...
                            <input type="text" name="totalOtherTraveller" class="form-control text-center drop-down-plus wd4 input-number" value="0" data-min="0" data-max="13" id="txtOtherDesk" readonly>
                            <span class="input-group-btn data-up ">
            ...
            <tr>
              <td class="col-md-3 pad-none">
                <div class="input-group date" id="dp5"> <span class="input-group-addon in border-radius"><span><img src="resources/images/calendar.png" alt=""></span></span>
                  <input name="departureDate" type="text" class="datepicker form-control border-radius" id="txtStartDateBtm" onblur="chkValidFlightDepartureDate(this, 'startDateBtmIn', '');">
                </div>
