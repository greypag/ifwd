                ...
                %>
						...
						<div class="col-lg-12 col-md-12 plan-box3 travelproductbox"
							...
							<div class="col-lg-8 col-md-8 col-sm-6 col-xs-6 pad-none">
								<h2>
									...
									<br> Premium Cover<br> HK$ 1,000,000 Medical
								</h2>
							</div>
								...
								<div class="fwdpanel-heading">
									<h4 class="benefits">
										<span><i class="fa fa-plus"></i> <a href="#"
											class="fwdpanel-minimize uline color-wht"> Plan benefits
										</a> </span>
									</h4>
								</div>
					...
					<div class="col-lg-4 col-md-4 gray-bg pad-none hidden-sm hidden-xs">
						...
						<div class="form-container">
							...
							<div class="form-group">
								<c:if
									test="${not empty travelQuoteBean.getTotalAdultTraveller()}">    ${travelQuoteBean.getTotalAdultTraveller()+travelQuoteBean.getTotalPersonalTraveller()}
                                Adults,        </c:if>
								<c:if
									test="${not empty travelQuoteBean.getTotalChildTraveller()}">    ${travelQuoteBean.getTotalChildTraveller()}
                                Childs,
                                </c:if>
								<c:if
									test="${not empty travelQuoteBean.getTotalOtherTraveller()}">    ${travelQuoteBean.getTotalOtherTraveller()}
                                Others</c:if>
							...
							<div class="form-group">
								<div class="input-group">
									<span class="text-red" id="errPromoCode"></span> <input
										...
										placeholder="eg.FWD789" />
										<button class="input-group-addon in black-bold" onclick="applyPromoCode()">APPLY</button>
								</div>								
							</div>
							...
							<input type="hidden" name="selectedAmountDue"
								ID="selectedAmountDue" value=""> <span class="text-red"
								id="errDue"></span>
    ...
    <div class="modal-content plan-modal">
      ...
      <form >
       ...
       <h2>Don't have a promotion code? Enter your email address and we'll send you one.</h2>
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6"> <a class="bdr-curve btn btn-primary btn-lg wd5" href="#" onclick="return sendEmail()">Submit</a> </div>
...
$(document).ready(function() {
      ...
      $(".travelproductbox").animate({ "background-color" : "#000"}, 3000);
    ...
    /*   $('#selectedAmountDue').value=selected_price; */
      ...
      document.getElementById("selectedDiscountAmt").value=discountAmt.trim();
      document.getElementById("txtgrossPremiumAmt").value=selected_price.trim();
    }
