...
<section id="main-slider" class="no-margin"> 
  <!--Mobile banner--> 
  <img src="resources/images/mob-travel/banner1.jpg" alt="" class="img-responsive hidden-lg hidden-md"  /> 
  <div class="carousel slide hidden-xs hidden-sm">
    <div class="carousel-inner">
      <div class="item active">

        <img src="resources/images/slider/bg1.jpg" alt=""  /> </div>
      <!--/.item--> 
    </div>
    <!--/.carousel inner--> 
  </div>
        ...
        <table class="table activation-form3">
          ...
          <tr>
              ...
              <span id="endDateDeskIn"  class="text-red" > </span>
                ...
                <div class="dropdown  form-group drop-down wh-bg input-group-div marg-b2" id="myFWDropdown">
                 
                  <a href="#" class="dropdown-toggle col-lg-12 col-md-12 pad-none" data-toggle="dropdown">  <label id="lblCountDesk"></label> <i class="fa fa-caret-down pull-right"></i> </a>
                      ...
                      <div class="plan_spinner_desk" id="family_plan_desk_spinner">
                        ...
                        <div class="col-lg-6">
                          <div class="input-group number-spinner none-bd" > <span class="input-group-btn data-dwn">
                            ...
                            <input type="text" class="form-control text-center drop-down-plus wd4 input-number" name="totalAdultTraveller" value="0" data-min="0" data-max="15" id="txtAdultsDesk" readonly>
                            <span class="input-group-btn data-up ">
                        ...
                        <div class="col-lg-6">
                          <div class="input-group number-spinner none-bd" > <span class="input-group-btn data-dwn">
                            ...
                            <input type="text" class="form-control text-center drop-down-plus wd4 input-number"  name="totalChildTraveller" value="0" data-min="0" data-max="15" id="txtChildDesk" readonly>
                            <span class="input-group-btn data-up ">
              ...
              <td class="col-md-2 pad-none"><div id="divPersonsDesk" style="visibility:hidden;">
                ...
                <button type="submit" class="border-radius btn btn-primary get-btn marg-t2 wd2">Get Quote</button></td>
            </tr>
          </tbody>
        </table>
       </div>
         ...
         <div class="plan_spinner_mob" id="family_plan_mob_spinner">
          ...
          <div class="col-xs-6 col-sm-6">
            <div class="input-group number-spinner none-bd "> 
              ...
              <input type="text" class="form-control text-center drop-down-plus input-number" value="0" data-min="0" data-max="15" id="txtAdultsMob" readonly />
              <span class="input-group-btn data-up ">
         ...
         <div class="col-xs-6 col-sm-6">
          ...
          <div class="col-xs-6 col-sm-6">
            <div class="input-group number-spinner none-bd "> 
              ...
              <input type="text" class="form-control text-center drop-down-plus input-number" value="0" data-min="0" data-max="15" id="txtChildMob"  readonly=""/>
              <span class="input-group-btn data-up ">
         ...
         <div class="col-xs-6 col-sm-6">
          ...
          <div class="col-xs-6 col-sm-6">
            <div class="input-group number-spinner none-bd "> 
              ...
              <input type="text" class="form-control text-center drop-down-plus input-number" value="1" data-min="0" data-max="15" id="txtOtherMob" readonly/>
              <span class="input-group-btn data-up ">
...
<div class="row mob-features hidden-lg hidden-md">
  <div class="col-xs-4 col-sm-4 text-center"> <img class="img-responsive" src="images/home1.png" alt=""  /> </div>
  ...
  <div class="clearfix"></div>
  <br>
  <div class="col-xs-4 col-sm-4 text-center"> <img class="img-responsive" src="images/home2.png" alt=""  /> </div>
  <div class="col-xs-8 col-sm-8">
    <div>
  ...
  <div class="clearfix"></div>
  <br>
  <div class="col-xs-4 col-sm-4 text-center"> <img class="img-responsive" src="images/home3.png" alt=""  /> </div>
  <div class="col-xs-8 col-sm-8">
    <div>
...
<div class="other-benefits col-lg-12 col-md-12 pad-none">
  ...
  <ul class="bullets">
    <li>
      <p class="h4-5">No out-of-pocket expenses - full cover with no excess<sup>*</sup> </p>
    </li>
    <li>
      <p class="h4-5"><sup>*</sup>Rental Vehicle Excess - Up to HK$5,000 reimbursement of out-of-pocket expenses arising from car accidents, loss or damage</p>
    </li>
    <li>
  ...
  <p class="h4-6">The features above are indicative only. Please refer to the <a href="policy-provisions-pdf/TravelCare_Provisions_Mar_2015.pdf" class="sub-link" target="_blank">Policy Provisions</a> for details. </p>
      ...
      <div class="col-lg-5 col-md-5 pad-none pull-left">
       ...
       <div class="col-lg-5 col-md-5 pad-none pull-right">
        <div class="testimonials-wrap text-center">
          <div class="testimonials-inner text-center">
            <div class="h1-1"> <blockquote class="testimonial"></blockquote></div>
            <p class="pad-none">I am a backpacker. The only 2 things I carry with me are my FWD TravelCare policy no. and ISOS emergency number – especially when you don’t know what to expect in the Amazon jungle.</p>
            <div class="hr1"></div>
            <h2>Gabriel</h2>
            <h4>aged 26</h4>
          </div>
    ...
    <div>
      <div class="col-lg-4 col-md-4 pad-none">
        <div class="services-wrap service-bx1">
          <div> <img class="img-responsive bdr-img" src="images/home4.png" alt="">
            <h3><a href="http://blog.fwd.com.hk/" target="_blank"> Things to do before<br> a long vacation <i class="fa fa-caret-right"></i></a> </h3>
      ...
      <div class="col-lg-4 col-md-4 pad-none">
        <div class="services-wrap service-bx2">
          <div> <img class="img-responsive bdr-img" src="images/home5.png" alt="">
            <h3><a href="http://blog.fwd.com.hk/"  target="_blank"> How to access internet while<br> travelling abroad <i class="fa fa-caret-right"></i> </a></h3>
      ...
      <div class="col-lg-4 col-md-4 pad-none">
        <div class="services-wrap service-bx3">
          <div> <img class="img-responsive bdr-img" src="images/home6.png" alt="">
            <h3><a href="http://blog.fwd.com.hk/" target="_blank"> Travelling with children<i class="fa fa-caret-right"></i></a> </h3>
            ...
            <tr>
              <td class="col-md-3 pad-none"><h3>When are you leaving?</h3>
                <div class="input-group date" id="dp5"> <span class="input-group-addon in border-radius"><span><img src="resources/images/calendar.png" alt=""></span></span>
                  <input name="trFooterLeavingDate" type="text" class="datepicker form-control border-radius" id="txtStartDateBtm">
                </div>
              ...
              <td class="col-md-3 pad-none"><h3>When will you be back?</h3>
                <div class="input-group date" id="dp6"> <span class="input-group-addon in border-radius"><span><img src="resources/images/calendar.png" alt=""></span></span>
                  <input name="trFooterBackDate" type="text" class="datepicker form-control border-radius" id="txtEndDateBtm">
                </div>
                <span id="endDateBtmIn" style="color:red"> </span></td>
              <td class="col-md-3 pad-none"><h3>Who’s travelling?</h3>
                <div class="dropdown  form-group drop-down wh-bg input-group-div marg-b2" id="myFWDropdownBtm">
                 
                  <a href="#" class="dropdown-toggle col-lg-12 col-md-12 pad-none" data-toggle="dropdown">  <label id="lblCountBtm"></label> <i class="fa fa-caret-down pull-right"></i> </a>
                  <div class="dropdown-menu bdr1">
                    <div class="drop-content">
                      <div class="col-lg-6">
                        <label class="radio radio-warning radio-inline">
                          <input type="radio" name="planbtm" id="personal_plan_btm" data-id="btm" class="plan" value="personal"  checked="" >
                          <label for="personal_plan_btm"> Personal <br>    Plan </label>
                         </label> 
                      </div>
                      <div class="col-lg-6">
                       <label class="radio radio-warning radio-inline">
                          <input type="radio" name="planbtm" id="family_plan_btm" data-id="btm" class="plan" value="family" >
                      ...
                      <div class="plan_spinner_btm" id="personal_plan_btm_spinner">
                        ...
                        <div class="col-lg-6">
                          <div class="input-group number-spinner none-bd" > <span class="input-group-btn data-dwn">
                            ...
                            <input type="text" class="form-control text-center drop-down-plus wd4 input-number" value="0" data-min="0" data-max="15" id="txtTravellersBtm" readonly>
                            <span class="input-group-btn data-up ">
                      ...
                      <div class="plan_spinner_btm" id="family_plan_btm_spinner">
                        ...
                        <div class="col-lg-6">
                          <div class="input-group number-spinner none-bd" > <span class="input-group-btn data-dwn">
                            ...
                            <input type="text" class="form-control text-center drop-down-plus wd4 input-number" value="0" data-min="0" data-max="15" id="txtAdultsBtm" readonly>
                            <span class="input-group-btn data-up ">
                        ...
                        <div class="col-lg-6">
                          <div class="input-group number-spinner none-bd" > <span class="input-group-btn data-dwn">
                            ...
                            <input type="text" class="form-control text-center drop-down-plus wd4 input-number" value="0" data-min="0" data-max="15" id="txtChildBtm" readonly>
                            <span class="input-group-btn data-up ">
                        ...
                        <div class="col-lg-6">
                          <div class="input-group number-spinner none-bd" > <span class="input-group-btn data-dwn">
                            ...
                            <input type="text" class="form-control text-center drop-down-plus wd4 input-number" value="0" data-min="0" data-max="15" id="txtOtherBtm" readonly>
                            <span class="input-group-btn data-up ">
              ...
              <td class="col-md-2 pad-none"><div id="divPersonsBtm" style="visibility:hidden;">
                ...
                <a href="travel-plan.html" class="border-radius btn btn-primary get-btn marg-t2 wd2" onclick="return flightValidateBtmTravel()">Get Quote</a></td>
            </tr>
          </tbody>
        </table>
      </div>
