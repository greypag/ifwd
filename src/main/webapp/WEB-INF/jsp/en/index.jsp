				...
				<div class="item active item-border">
					<div
						...
						<a href="flight" class="border-radius btn btn-primary  home-btn">Flight
							...
							class="border-radius btn btn-primary  home-btn">Travel
							Insurance</a> <a href="homecare"
							class="border-radius btn btn-primary  home-btn">Home
							Insurance</a>
					...
					<div class="recent-work-wrap wrap text-center">
						<div class="recent-work-inner">
							...
							<p>We continue to find you great rewards and benefits that
								...
								insurance, Agoda Y5Buddy, and more.</p>
							...
							<div class="recent-work-wrap text-center">
								<div class="recent-work-inner">
									...
									<p>
										...
										Kong and our eServices <a
											href="http://www.fwd.com.hk/en-US/fwd-n-you/e_services_app.html"
											target="_blank">App </a> ensures you get the support you
						...
						<div class="slide-margin">
							<div class="testimonials-wrap text-center">
								<div class="testimonials-inner text-center">
									...
									<p>I always go for FWD Travel Insurance because there is
										always someone to pick up my calls, 24/7, which is
										particularly important after office hours and while I am
										travelling overseas.</p>
									<div class="hr1"></div>
									<h2>William</h2>
						...
						<div class="slide-margin">
							<div class="testimonials-wrap text-center">
								<div class="testimonials-inner text-center">
									...
									<p>I am a backpacker. The only 2 things I carry with me are
										my FWD TravelCare policy no. and ISOS emergency number –
										especially when you don’t know what to expect in the Amazon
										jungle.</p>
