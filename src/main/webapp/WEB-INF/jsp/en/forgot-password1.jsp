									...
									<tr>
										...
										<td class="pad-none"><input type="text"
											...
											id="errorEmptyMob" style="display: none"><label
												style="color: red">Please enter mobile no</label></span> <span
											id="errorInvalidMob" style="display: none"><label
												style="color: red">Mobile No. must be 8 digits,
													please enter again</label></span></td>
									</tr>
									<tr>
										<td valign="middle" class="pad-none"><label
										...
										<td class="pad-none"><input type="email"
											...
											style="display: none"><label style="color: red">Please
													enter email address</label></span> <span id="errorInvalidEmailId"
											style="display: none"><label style="color: red">Please
													enter a valid Email Address</label></span></td>
									</tr>
									<tr>
										<td valign="middle" class="pad-none"><label
										...
										<td class="pad-none"><input type="text" name="userName"
											...
											<span id="errorEmptyUName" style="display: none"><label
												style="color: red">Please enter User Name</label></span> <span
											id="errorInvalidUName" style="display: none"><label
												style="color: red">Please enter a valid user name</label></span></td>
										<td class="width1"></td>
