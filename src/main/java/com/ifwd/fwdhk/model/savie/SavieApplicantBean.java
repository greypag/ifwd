...
import com.ifwd.fwdhk.util.CommonEnum.MaritalEnum;
...
public class SavieApplicantBean {
	...
	private List<SavieFormFNABean> FNA;
	...
	public List<SavieFormFNABean> getFNA() {
		return FNA;
	}

	public void setFNA(List<SavieFormFNABean> fNA) {
		FNA = fNA;
	}
