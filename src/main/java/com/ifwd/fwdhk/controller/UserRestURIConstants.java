...
public class UserRestURIConstants {
	...
	// Travel URL
	public static final String ANNUAL_TRAVEL_GET_QUOTE = getProperties("annual_url")
			+ "/gi/annualTravel/quote";
	public static final String ANNUAL_TRAVEL_CREATE_POLICY = getProperties("annual_url")
			+ "/gi/annualTravel/policies";
	public static final String ANNUAL_TRAVEL_CONFIRM_POLICY = getProperties("annual_url")
			+ "/gi/annualTravel/payments/make";
	public static final String ANNUAL_TRAVEL_FINALIZE_POLICY = getProperties("annual_url")
			+ "/gi/annualTravel/policies";
