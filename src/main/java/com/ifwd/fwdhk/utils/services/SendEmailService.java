...
public class SendEmailService implements SendEmailDao {
	...
	public boolean sendCslPromotionEmail(HttpServletRequest request, String recipientEmail, HashMap<String, String> header) {
		...
		emailParams.put("subject", "25% off data roaming SIM from FWD | 富衛附送您數據儲值卡75折優惠");
	...
	public boolean sendEmailByDiscover(String offername, String username,
		...
		if (offername.equals("Fanfare.offername5")) {
			...
			message = "<html>"+
						 ...
						 "                                                <p dir=\"ltr\" style=\"line-height:125%;margin-top:0pt;margin-bottom:10pt;text-align:left;margin:1em 0;padding:0;color:#606060;font-family:Microsoft JhengHei,Calibri,sans-serif;font-size:15px\"><span><span style=\"background-color:transparent;color:#000000;font-family:microsoft jhenghei,calibri,sans-serif;font-size:13.3333px;vertical-align:baseline;white-space:pre-wrap\">Congratulations! You have successfully redeemed your promotion code for " + offerName_en + " from <span style=\"font-family: calibri, sans-serif;\">FWD ● discover</span>.</br></br>"+ discount_en +"</br>Designated Product: " + planName_en + "</br>Promotion code: " + code + "</br>Expiry Date: "+ date +
	...
	public boolean sendY5buddyEmail(HttpServletRequest request, String recipientEmail, HashMap<String, String> header) {
        ...
        String message = "<html>" +
        		...
        		"                                                  </p> &nbsp;   " +
        		"                                                  <p dir=\"ltr\" style=\"line-height:125%;margin-top:0pt;margin-bottom:10pt;text-align:left;margin:1em 0;padding:0;color:#606060;font-family:Microsoft JhengHei,Calibri,sans-serif;font-size:15px\"><span><span style=\"background-color:transparent;color:#000000;font-family:microsoft jhenghei,calibri,sans-serif;font-size:13.3333px;vertical-align:baseline;white-space:pre-wrap\">For enquiry，please contact our FWD 24 hours Customer Hotline at (852) 3123 3123 or via email at <a href=\"mailto:iService.hk@fwd.com\">iService.hk@fwd.com</a>.</p>" +
        		"                                                  <p dir=\"ltr\" style=\"line-height:125%;margin-top:0pt;margin-bottom:10pt;text-align:left;margin:1em 0;padding:0;color:#606060;font-family:Microsoft JhengHei,Calibri,sans-serif;font-size:15px\"><span><span style=\"background-color:transparent;color:#000000;font-family:microsoft jhenghei,calibri,sans-serif;font-size:13.3333px;vertical-align:baseline;white-space:pre-wrap\">如有任何查詢，請致電富衛24小時客戶熱線(852) 3123 3123或電郵至<a href=\"mailto:iService.hk@fwd.com\">iService.hk@fwd.com</a>。</p>" +
        		"                                                </div>" +
        		"                                              </td>" +
        		"                                            </tr>" +
        		"                                          </tbody>" +
