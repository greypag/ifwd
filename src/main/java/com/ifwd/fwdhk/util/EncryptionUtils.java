...
public class EncryptionUtils {
	...
	public static String encryptByRSA(String source) throws Exception{
        ...
        X509EncodedKeySpec publicKeySpec = new X509EncodedKeySpec(Base64.decodeBase64(UserRestURIConstants.PUBLIC_KEY));
	...
	public static String encryptByHMACSHA512(String source) {
		System.out.println("source:\n"+source);
		String result = "";
		byte[] bytesKey = UserRestURIConstants.API_KEI.getBytes();
