...
public class HMAC {  
    ...
    public static void main(String[] args) throws Exception {  
        String key = "mBPboCOJ/HITwkNRd9iCWuXxZbgbLqQlHhHNs4dY/yJB0YnL3chyqiUWUHuz88Rj7AC7i2wCZyC98hJs1jFZnQ==";//HMAC.init();  
        System.out.println("Mac密钥:\n" + key);  
        String word = "{\"chiMessage\":\"請求完成\",\"engMessage\":\"Request Success\",\"internal\":\"Request Success\",\"payload\":{\"merTradeNo\":\"123\",\"tradeNo\":\"1606104976607021\",\"tradeStatus\":\"TRADE_FINISHED\"},\"resultCode\":\"0\"}";  
